        ...
        <div class="row">
            <div class="col-xs-12 clearleft clearright">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearleft clearright remove-padding">
                     <?php $form = ActiveForm::begin(['action' => \yii\helpers\Url::base() . '/cart/checkout/step/deliveryinformation', "id" => "newshipping-form"]) ?>
                    
<div class="form-input-wrap col-md-12 col-sm-12 remove-padding">

	<div class="rounded-input-wrap">
		<label for="firstname">First Name</label>
		<input class="rounded-input remove-margin-top" type="text" name="fname" placeholder="First Name" value="<?php echo $customerAddress['firstname']; ?>" pattern="[a-zA-Z0-9\s]+" required/>
		<span class="dnone gotham-light error-input-message">* First Name Required</span>
	</div>

	<div class="rounded-input-wrap">
		<label for="lastname">Last Name</label>
		<input class="rounded-input" type="text" name="lname" placeholder="Last Name"  value="<?php echo $customerAddress['lastname']; ?>" pattern="[a-zA-Z0-9\s]+" required/>
		<span class="dnone gotham-light error-input-message">* Last Name Required</span>
	</div>

	<div class="rounded-input-wrap">
		<label for="address1">Address</label>
		<textarea rows="4" class="rounded-input" name="address" placeholder="Address" required> <?php echo $customerAddress['address1']; ?></textarea>
		<span class="dnone gotham-light error-input-message">* Address Required</span>
	</div>

	<div class="rounded-input-wrap">
		<label for="phone">Mobile Phone</label>
		<input class="rounded-input" type="number" name="phone" placeholder="Mobile Phone" value="<?php echo $customerAddress['phone']; ?>" required/>
		<span class="dnone gotham-light error-input-message">* Mobile Phone Required </span>
	</div>

	<div class="rounded-input-wrap">
		<label for="postcode">Zip Code</label>
		<input class="rounded-input" type="number" name="zip" placeholder="Zip Code" value="<?php echo $customerAddress['postcode']; ?>" pattern="[0-9]{5}" maxlength="5" required/>
