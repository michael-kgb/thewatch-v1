...
$('a#upload-service').on('click', function (e) {
        e.preventDefault();
       check_image_format('file-1');
       check_image_format('file-2');
       check_image_format('file-3');
       check_image_format('file-4');
       check_image_format('file-5');
       check_image_format('file-6');
...
$('a#create-warranty').on('click', function (e) {
        ...
        if($("input[name='nomor_invoice']").val() == '' && $('#file-2')[0].files.length == 0){
          $('span#error-invoice').css('display','block');
          return false;
        }
