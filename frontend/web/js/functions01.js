...
if (document.getElementById('brand-collection-button')) {

var fixmeTop = $('section#brand-collection-button').offset().top;
    $(window).scroll(function() {
...
//    alert(rbID);
    ...
    var attribute_value_id = $('select.color').length && !$('select.color').is(':disabled') ? $col_value[0] : '',
            id = $('input[name=product_id]')[0].value,
            reference = '',
            product_attribute_id = $('select.color').length && !$('select.color').is(':disabled') ? $('select.color option:selected').attr("attrId") : 0,
            quantity = $('select.qty')[0].value,
            name = $('input[name=product_name]')[0].value,
            price = $('input[name=price]')[0].value,
            brandName = $('input[name=brand_name]')[0].value,
...
//            Veritrans.client_key = "VT-client-mjABlnYixiNp15XZ";
            ...
            $('input[name=payment_method_id]').val($('input:radio[name=payment_method_radio]:checked')[0].value);
            var card = function () {
                return {
            ...
            $.ajax({
                ...
                data: {
					"paymentMethod": {
                        ...
                        "payment_method_id": $('input[type="radio"][name=payment_method_radio]:checked').val(),
...
$('input#apply-filters').click(function() {
    ...
    params = brands_param + size_fil + bandwidth_fil + gender_fil + type_fil + water_fil + movement_fil + category_param + sort_param + price_param;
    pagination = '&page=1&limit=20';
