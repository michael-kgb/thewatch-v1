...
$('a#choose-service').on('click', function (e) {
        ...
        $('input[name="service_type"]:checked').each(function() {
           ...
           if($(this).attr("id") == 'Lainnya'){
               othr_atr = ' : ' + $("#other-text").val();
           }
           atr = atr + $(this).attr("id") + othr_atr + '<br>';
        });
        // if(stuff == []){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data['front'] != ''){
                  ...
                  $('span#tampak-depan').html('Tampak Depan');
                }
                if(data['right'] != ''){
                  ...
                  $('span#tampak-kanan').html('Tampak Kanan');
                }
                if(data['left'] != ''){
                  ...
                  $('span#tampak-kiri').html('Tampak Kiri');
                }
                if(data['top'] != ''){
                  ...
                  $('span#tampak-atas').html('Tampak Atas');
                }
                if(data['bottom'] != ''){
                  ...
                  $('span#tampak-bawah').html('Tampak Bawah');
                }
                if(data['back'] != ''){
                  ...
                  $('span#tampak-belakang').html('Tampak Belakang');
                }
...
// $("#preview-lokasi-pengirim").click(function() {
//   setTimeout(function() { $('input[name="customer-name-warranty"]').focus() }, 3000);
//   // $('input[name="customer-name-warranty"]').get(0).focus();
// });
