...
<?php
    ...
    $query = \backend\models\BrandsBannerDetail::find()
        ...
        $brand = $query
                ...
                ->where(["brands.brand_new_arrival" => 1])
                ->andWhere(["brands_banner_detail.brands_banner_featured_brand" => 1])
                ->andWhere(['<=', 'brands.brand_new_arrival_start', $current_date])
                ->andWhere(['>=', 'brands.brand_new_arrival_end', $current_date])
...
<section id="featured-brands" style="padding:0;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 shop-title caption">NEW ARRIVAL</div>
    ...
    <div class="container category">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 featured-brands-homepage" style="">
                <div class="col-lg-5 col-md-5 col-sm-5 hidden-xs category block" style="padding-right: 25px;">
                        ...
                        <ol class="carousel-indicators">
                            ...
                            <?php if (count($brand) > 1) { ?>
                                <?php foreach ($brand as $banner) { ?>
                                    <li style="" data-target="#myCarousel2" data-slide-to="<?php echo $i; ?>" class="hidden-sm brand-homepage-carousel <?php echo $i === 0 ? 'active' : ''; ?>"></li>
                                    <?php $i++; ?>
                                <?php } ?>
                            <?php } ?>
                        </ol>
                                ...
                                <?php foreach ($brand as $banner) { ?>
                                    ...
                                    <div class="item <?php echo $i === 1 ? 'active' : ''; ?>">
                                        <a href="<?php echo \yii\helpers\Url::base() . '/brand/' . $banner->brands->link_rewrite; ?>">
                                            <img src="<?php echo \yii\helpers\Url::base(); ?>/frontend/web/img/brand_banner/<?php echo $banner->brands_brand_id;?>/<?php echo $banner->brands_banner_detail_slide_image; ?>" class="img-responsive remove-padding" style="width: 100%">
                                        </a>
                                        <?php 
                                        if($i == 1){
                    ...
                    <div class="col-lg-12 clearright clearleft" style="padding-top: 20px;padding-bottom: 15px;font-size: 14px;font-family: gotham-light;">
                        Lihat Semua Koleksi <?php echo $brand_name;?>
                    </div>
                    <div class="col-lg-12 clearright clearleft">
                        <a class="blue-round featured-banner-see-more button" href="<?php echo \yii\helpers\Url::base() . '/brand/' . $brand_rewrite; ?>" style="position: relative;float: left;margin-left: 0px;font-size: 14px;font-family: gotham-light;">KLIK DISINI</a>
                    </div>
                ...
                <div class="hidden-lg hidden-md hidden-sm col-xs-12" style="padding:0px">
                    ...
                    <div id="" class="swiper-container-featured-brand-new" style="overflow-x:hidden;position: relative;overflow-y: hidden;">  
                        <div class="swiper-wrapper clearleft clearright" style="">
                                ...
                                <div class="swiper-slide">
                                    <a href="<?php echo \yii\helpers\Url::base() . '/brand/' . $row->brands->link_rewrite; ?>">
                                        <img src="<?php echo \yii\helpers\Url::base(); ?>/frontend/web/img/brand_banner/<?php echo $row->brands_brand_id;?>/<?php echo $row->brands_banner_detail_slide_image; ?>" class="" style="width: 100%;padding-right:0px;">
                                     </a>  
                                </div>
                                <?php $i++; ?>
                                <?php } ?>
                        ...
                        <div class="swiper-pagination" style="height:45px;margin-top:-45px;"></div>
                    <!-- Add Arrows -->
                        
                                                        <div class="swiper-button-next" style="background-image:none;top:50%;"><img src="<?php echo \yii\helpers\Url::base(); ?>/frontend/web/img/icons/next_slide_transparant.png" style="width: 40px;"></div>
                                                        <div class="swiper-button-prev" style="background-image:none;top:50%"><img src="<?php echo \yii\helpers\Url::base(); ?>/frontend/web/img/icons/prev_slide_transparant.png" style="width: 40px;;"></div>
                                                      <?php } ?>
                ...
                <?php if (count($productRelated) > 0) { ?>
                            ...
                            <div id="" class="swiper-container-featured-brand-product-desktop-new hidden-xs col-lg-7 col-md-7 col-sm-7 clearleft clearright" style="overflow-x:hidden;position: relative;overflow-y: hidden;">
                        ...
                        <div class="hidden-xs col-lg-12 clearleft clearright <?php if($i % 2 == 0){echo 'kanan';}else{echo 'kiri';}?>">
                                    ...
                                    ?>
                                        ...
                                        ?>
                                          ...
                                          ?>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 product gotham-medium brand-title" style="padding-top:16px;padding-bottom: 8px;"><?php echo $related->brands->brand_name; ?></div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 product gotham-light product-name" style="padding-bottom: 12px;"><?php echo $related->productDetail->name; ?></div>
                                                <?php
                            ...
                            ?>
                                        ...
                                        <?php if($i == 4){ ?>
                                            <div class="swiper-slide clearleft clearright">
                                ...
                                <!-- <div class="swiper-pagination" style="height:35px;margin-top:10px;"></div> -->
                                    ...
                                    <div class="swiper-button-prev featured-desktop" style="background-image:none;right: 10px;"><img src="<?php echo \yii\helpers\Url::base(); ?>/frontend/web/img/icons/prev_slide_gold.png" style="width: 40px;"></div>
                ...
                <div class="hidden-lg hidden-md hidden-sm col-xs-12" style="padding-top:15px;"></div>
                    <?php if (count($productRelated) > 0) { ?>
                            ...
                            <div id="" class="swiper-container-featured-brand-product-new hidden-lg hidden-md hidden-sm col-xs-12 clearleft-mobile clearright-mobile" style="overflow-x:hidden;position: relative;overflow-y: hidden;">
