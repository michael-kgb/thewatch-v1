<section id="all-brands">
    <div class="container breadcrumb-page">
        ...
        <div class="row hidden-xs hidden-sm hidden-md">
            ...
            <div class="hidden-xs filter-box" id="box-filter">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <?php if($category->product_category_name != 'straps'){ ?>
                        ...
                        foreach ($feature as $row) {
                            ...
                            if (strtoupper($row->feature_name) != 'SIZE' && strtoupper($row->feature_name) != 'BANDWIDTH' && strtoupper($row->feature_name) != 'WATER RESISTANT') {
                                if (strtoupper($row->feature_name) == 'MOVEMENT' && $category->product_category_name == 'straps'){
