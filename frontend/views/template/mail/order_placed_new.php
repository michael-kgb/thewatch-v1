            ...
            <table width="600" align="center" cellpadding="0" cellspacing="0">
              ...
              <tbody>
                <tr>
                      ...
                      <table width="600" cellspacing="0" cellpadding="0" align="center" style="padding-bottom:35px;padding-top:35px;">
                        <tr>
                          ...
                          <td align="center" width="570">
                            <?php 
                            // $model = \backend\models\Orders::find()->where(['orders_id'=>1000])->one();
                            $payment = \backend\models\Payment::findOne(['payment_id' => $model->paymentmethoddetail->payment_id]);
                            $paymentMethod = \backend\models\PaymentMethod::findOne(['payment_method_id' => $model->paymentmethoddetail->payment_method_id]);
                            ...
                            $grandTotal -= $discount;
                            // echo date('l, d F Y, h:i', strtotime($model->date_add));
                            $status = \backend\models\OrderHistory::find()
                            ->orderBy("order_history_id DESC")
                            ->where(["orders_id" => $model->orders_id])
                            ->one();

                            if($paymentMethod->payment_method_alias == 'cc' || $paymentMethod->payment_method_alias == 'ip'){
                              ?>
                            ...
                            <?php } else if($paymentMethod->payment_method_alias == 'bt') { ?>
                               <div style="font-size:14px;line-height:1.3;text-align:center;font-family:Helvetica;margin-bottom: 15px;">
                                  ...
                                  <?php }else{ ?>
                                    Sisa waktu pembayaran Anda tinggal 24 jam kemudian, silahkan selesaikan pembayaran Anda melalui nomor rekening yang telah Anda pilih. <br>
                                    Checkout berhasil pada <?php echo date('l, d F Y, h:i', strtotime($model->date_add)); ?> WIB
                                  <?php } ?>
                                ...
                                <div style="font-size:14px;line-height:1.3;text-align:center;font-family:Helvetica;margin-bottom: 15px;">
                                  ...
                                  <?php if($model->pre_order == 1){?>
                                    1 September 2018
                                  <?php }else{ ?>
                                    <?php echo date('l, d F Y, h:i', strtotime("+1 day", strtotime($model->date_add))); ?> WIB
                                  <?php } ?>
                                ...
                                <a href="" style="color: rgb(32,97,103);">Invoice</a>
                                </div>
                                <br> -->
                                ...
                                <div style="font-size:14px;line-height:1.3;text-align:center;font-family:Helvetica;margin-bottom: 15px;">
                                  <strong>Nomor Rekening PT. Kami Gawi Berjaya</strong><br>
                                  Kirim ke No. Rekening di bawah
                                </div>

                                <table width="570" align="left" cellpadding="0" cellspacing="0" style="margin-top:15px;margin-bottom:20px;">
                                  <tr>
                                    <td width="235"></td>
                                    <td style="font-size:0;line-height:0;" height="25" width="100"> 
                                      <img src="https://thewatch.co/img/icons/<?php echo $payment->filename; ?>">
                                    </td>
                                    <td width="235"></td>
                                  </tr>
                                </table>
                                ...
                                <div style="font-size:14px;line-height:1.3;text-align:center;font-family:Helvetica;margin-bottom: 15px;">
                                  <?php echo $payment->account_number; ?><br>
                                  a/n <?php echo $payment->name_person; ?>
                                </div>
                                <br>
                            
                                <div style="font-size:14px;line-height:1.3;text-align:center;font-family:Helvetica;margin-bottom: 15px;">
                                  <strong>Status Pembayaran</strong><br>
                                  <?php echo $status->orderStateLang->text; ?>
                                </div>
                                <br>
                                ...
                                <div style="font-size:14px;line-height:1.3;text-align:center;font-family:Helvetica;margin-bottom: 15px;">
                                  ...
                                  <a href="http://thewatch.co/user/order/confirmation/<?php echo $ordersId; ?>" style="color: #fff;padding: 8px;background-color: rgb(32,97,103);border-radius: 50px;margin-top: 20px;text-align: center;border: 1px solid rgb(32,97,103);font-size: 14px;text-decoration: unset;padding-left: 30px;padding-right: 30px;">Konfirmasi Pembayaran</a>
                                </div>
                                <br>
                            <?php } ?>
                            ...
                            <table width="570" align="left" cellpadding="0" cellspacing="0" style="margin-top:15px;margin-bottom:20px;font-size: 12px;background-color: rgb(32,97,103);color: #fff;border-radius: 5px;">
                              ...
                              <tr>
                                <td width="100" style="text-align: center;padding-top: 10px;padding-bottom: 10px;border-right: 1px solid #fff;">
                                  <?php
                                    $product_image = \backend\models\ProductImage::find()->where(['product_id'=>$item['id']])->andWhere(['cover'=>1])->one();
                                  ?>
                                ...
                                <td width="190" style="text-align: left;padding-top: 10px;padding-bottom: 10px;border: 1px solid #fff;padding-left: 5px;padding-right: 5px;">
                                  <div style="padding-left: 5px;"><?php echo $item['name']; ?>  <?php echo isset($item['color']) ? $item['color'] : ''; ?></div></td>
                                <td width="90" style="text-align: center;padding-top: 10px;padding-bottom: 10px;border: 1px solid #fff;padding-left: 5px;padding-right: 5px;"><?php echo $item['quantity']; ?></td>
                                ...
                                <div style="padding-right: 20px;">Rp. <?php echo \common\components\Helpers::getPriceFormat($item['unit_price']); ?></div></td>
                              ...
                              <tr>
                                ...
                                <td width="190" style="text-align: right;padding-top: 10px;padding-bottom: 10px;border-top: 1px solid #fff;padding-left: 5px;padding-right: 5px;">
                                  ...
                                  <?php if($model->unique_code != 0) { ?>
                                  <div style="padding-right: 20px;padding-bottom: 3px;"> <?php echo \common\components\Helpers::getPriceFormat($model->unique_code); ?></div>
                                  <?php } ?>
                                  <?php if($discount != 0) { ?>
                            ...
                            <div style="font-size:14px;line-height:1.3;text-align:center;font-family:Helvetica;margin-bottom: 15px;">
                              ...
                              Demi keamanan transaksi Anda, pastikan untuk tidak menginformasikan bukti dan data pembayaran kepada pihak manapun kecuali The Watch Co.
                            </div>
                            <br>
                  ...
                  <tr>
                    <td>
                      <table width="600" cellspacing="0" cellpadding="0" align="center" style="padding-bottom:35px;padding-top:25px;">
                        <tr>
                          <!-- Row container for Intro/ Description -->
                          <td width="15"></td>
                          <td align="center" width="570">
                            ...
                            <div style="font-size:14px;line-height:1.3;text-align:left;font-family:Helvetica;margin-bottom: 15px;">
                              Setiap kali Anda melakukan pemesanan, system kami akan secara otomatis mengirimkan pesan konfirmasi ke alamat email yang Anda berikan.
                              Kami membutuhkan waktu maksimal 5 hari kerja untuk memproses pesanan Anda. Proses tersebut kami butuhkan untuk melakukan konfirmasi pembayaran, uji kelayakan produk, pengemasan dan persiapan pengiriman. Detail Pengiriman:
                            </div>
                            
                            <table width="570" align="left" style="font-size:14px;line-height:1.3;text-align:left;font-family:Helvetica;margin-bottom: 15px;">
                                            <tbody>
                                            <tr>
                                              <td width="150"><strong>Services</strong></td>
                                              <td width="420"><strong>Estimated</strong></td>
                                            </tr>
                                            <tr>
                                              <td width="150"><left>Regular</left></td>
                                              <td width="420"><left>3 - 4 working days</left></td>
                                            </tr>
                                            <tr>
                                              <td width="150"><left>YES</left></td>
                                              <td width="420"><left>1 - 2 working days</left></td>
                                            </tr>
                                            </tbody>
                                          </table>
                            <br>
                            <div style="font-size:14px;line-height:1.3;text-align:left;font-family:Helvetica;margin-bottom: 15px;">
                              Resi pengiriman (tracking number) secara otomatis akan dikirimkan ke alamat email yang Anda berikan. Mohon dipahami bahwa pengecekan baru dapat dilakukan dalam 1 x 24 jam setelah Anda menerima resi tersebut.
                            </div>
                            ...
                            <div style="font-size:14px;line-height:1.3;text-align:left;font-family:Helvetica;margin-bottom: 15px;">
                              Once you placed an order, we will send an email about your order information.
                              We need 5 days to proceed your order to confirm your payment, quality control, packing, and preparing the shipment.
                            ...
                            <div style="font-size:14px;line-height:1.3;text-align:left;font-family:Helvetica;margin-bottom: 15px;">
                              The shipping tracking number will automatically send to your email then you will be able to check the shipping status in 24 hour.
                            </div>
                    ...
                    <table width="300" align="left" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td>
                          ...
                          <div align="left" style="font-size:12px;color:#454545;text-align:left;font-family:Helvetica;margin-left:15px;">
                            <a href="https://www.thewatch.co/shipping-information" style="text-decoration:none;color:#454545;">Shipping Information</a>
                          </div>
