...
<div class="row">
    ...
    <header id="myCarousel" class="carousel slide col-lg-4 col-md-6 col-sm-6 col-xs-12 clearleft"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <!-- Indicators -->
    ...
    <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 clearright hidedevice" >
    ...
    <h1>casascasc</h1>
      <div class="container product-box clearleft" style="padding-top:20px;">
        <div class="row">
		  ...
		  if($this->context->action->id == "detail"){
			  echo Yii::$app->view->renderFile('@app/views/brands/filter_detail.php', array(
				  "feature" => $feature, 
				  "products"=> $products,
				  "types_selection" => $types_selection,
				  "genders_selection" => $genders_selection,
        ...
        <?php if ($i == 5 || $i == 9 ||
                ...
                <div class="hidden-sm col-lg-12 col-md-12 cont product-box clearleft clearright clearleft-mobile clearright-mobile">
                    <div class="row">
        <?php } ?>
                    <div class="hidden-sm col-lg-3 col-md-3 col-xs-6 space-product <?php echo $i % 2 == 0 ? 'pleft75' : 'pright75'; ?> mbottom-3-mobile" style="pointer-events: <?php echo $product->disable_click === 1 ? 'none;' : 'auto;'; ?>">
                        <?php
                            ...
                            <div style="position: relative;">
                                ...
                                <div class="tag">
                                    ...
                                    ?>
                                        ...
                                        ?>
                                             <div class="tag-bellow tag-bellow2" style='background-color: #c54245;position: absolute;bottom: 0px;width: 100%;top:auto;'>
                                                <div class=''>
                                                    <span class='text-bellow'>
                                                    Limited Edition
                                          ...
                                          <?php
                                            if(in_array($product->product_id, [883, 1065, 1066, 2195, 3423])){
                                        ?>
                                             <div class="tag-bellow tag-bellow2" style='background-color: #4c757b;position: absolute;bottom: 0px;width: 100%;top:auto;'>
                                                <div class=''>
                                                    <span class='text-bellow'>
                                        ...
                                        ?>
                                          ...
                                          <?php
                                            ...
                                            if(in_array($product->product_id, [4155])){
                                        ?>
                                             <div class="tag-bellow tag-bellow2" style='background-color: #c54245;position: absolute;bottom: 0px;width: 100%;top:auto;'>
                                                <div class=''>
                                                    <span class='text-bellow'>
                                                    GIFT SET SAVE IDR 760,000
                                          ...
                                          <?php
                                            ...
                                            if(strtolower($product->brands->brand_name)=="fitbit"){
                                          ?>
                                        
                                        
                                        <div class="tag-bellow tag-bellow2" style='background-color: #206167;position: absolute;width: 100%;bottom: 0;top: auto;'>
                                                ...
                                                <div class=''>
                                                    ...
                                                    <span class='text-bellow'>  
                                                      ...
                                                      <button class='btn btn-link btn-xs pull-right openFeatureButton' onclick='openModalFeatureImage(event, <?= $product->brands_collection_id ?>)'
                                                      >
                                                        See Feature
                                                      </button>
                                                    </span>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="border:0;">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="position:relative;z-index:2;"><span aria-hidden="true" style="font-size:30pt;color:gray;">&times;</span></button>
      </div>
      <div class="modal-body">
        <img width="100%" id="featureCollectionImage" src="" style="position:relative;margin-top:-40px;z-index:1;">
      </div>
    </div>
  </div>
</div>
...
<style>
    ...
    .openFeatureButton{
      color: #fff;text-decoration:none;border:1px solid #fff;margin:7px;
    }

    .openFeatureButton:hover, .openFeatureButton:visited, .openFeatureButton:active{
      color:#206167;background-color:#fff;text-decoration:none;
    }
</style>
