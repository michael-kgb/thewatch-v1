...
var dataLayer = [],
    ...
    items.push({
        ...
        "position": <?php echo $i; ?>,
        "list": "Landing Page Promo Akulaku Pay"
    })
    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearleft clearright mbottom3">
				<img src="<?php echo \yii\helpers\Url::base(); ?>/img/landing/akulakupay/akulaku_home_banner_d_0819.jpg" class="img-responsive">
			</div>
                ...
                <div class="container breadcrumb-page">
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-9 breadcrumb-page clearleft clearright">
                            ...
                            <a href="<?php echo \yii\helpers\Url::base() . '/akulaku' . '?' . $params . '&page=1&limit=20'; ?>&sortby=<?php echo $sortby;?>" class="fleft pright2 hidden-xs hidden-sm hidden-md"><span class="gotham-<?php echo!isset($_GET['limit']) || $_GET['limit'] == 20 ? 'medium' : 'light'; ?>">20</span></a>
                            <a href="<?php echo \yii\helpers\Url::base() . '/akulaku' . '?' . $params . '&page=1&limit=40'; ?>&sortby=<?php echo $sortby;?>" class="fleft pright2 hidden-xs hidden-sm hidden-md"><span class="gotham-<?php echo isset($_GET['limit']) && $_GET['limit'] == 40 ? 'medium' : 'light'; ?>">40</span></a>
                            <a href="<?php echo \yii\helpers\Url::base() . '/akulaku' . '?' . $params . '&page=1&limit=60'; ?>&sortby=<?php echo $sortby;?>" class="fleft pright2 hidden-xs hidden-sm hidden-md"><span class="gotham-<?php echo isset($_GET['limit']) && $_GET['limit'] == 60 ? 'medium' : 'light'; ?>">60</span></a>
						</div>
                        <div class="col-lg-3 show-number clearright clearleft" style="text-align: left;width: 21%;float: right;    line-height: 32px;">
                            ...
                            <div class="clearleft clearright hidden-xs hidden-sm hidden-md hidden-lg-4" style="display: inline;">
                                ...
                                <div class="hidden-xs sorting-box" id="box-sorting">
                                    <a class="sorting-list top" href="<?php echo \yii\helpers\Url::base() . '/akulaku' . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=none'; ?>">BRANDS NAME</a>
                                    <a class="sorting-list" id="sorting-none" href="<?php echo \yii\helpers\Url::base() . '/akulaku' . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=price-low-to-high'; ?>">PRICE LOW TO HIGH</a>
                                    <a class="sorting-list bottom" href="<?php echo \yii\helpers\Url::base() . '/akulaku' . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=price-high-to-low'; ?>">PRICE HIGH TO LOW</a>
                                </div>
                            </div>
                            <style type="text/css">
                        ...
                        <div class="hidden-lg hidden-md col-xs-12 remove-padding" style="display: none; position: fixed; width: 100%; height: 100%; left: 0; top: 0px; background: #f6f6f6; z-index: 10; overflow: auto" id="sorting-content">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <a href="<?php echo \yii\helpers\Url::base() . '/akulaku' . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=none'; ?>">
                                ...
                                <a href="<?php echo \yii\helpers\Url::base() . '/akulaku' . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=price-low-to-high'; ?>">
                                    <div class="col-xs-12 padding-bottom-3 border-bottom-1 margin-top-3 remove-padding-left remove-padding-right" style="padding-top:8px;">
                                ...
                                <a href="<?php echo \yii\helpers\Url::base() . '/akulaku' . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=price-high-to-low'; ?>">
                                    <div class="col-xs-12 padding-bottom-3 border-bottom-1 margin-top-3 remove-padding-left remove-padding-right" style="padding-top:8px;">
            ...
            if($current_date >= '2019-08-01 00:00:00' && $current_date <= '2019-08-31 23:59:59'){
								...
								<div class="hidden-sm col-lg-3 col-md-3 space-product col-xs-6 <?php echo $i % 2 == 0 ? 'pleft75' : 'pright75'; ?> mbottom-3-mobile">
									...
									<a class="productClick" <?php echo $stock->quantity == 0 ? 'id="out-of-stock" data-id="'.$product->product_id.'"' : ''; ?> href="<?php echo \yii\helpers\Url::base(); ?>/product/<?php echo $product->productDetail->link_rewrite; ?>">
										...
										<div style="position:relative;">
											...
											if($stock != NULL){
											?>
											<img alt="<?php echo $product->brands->brand_name . ' ' . $product->productDetail->name; ?>" src="<?php echo Yii::$app->params['frontendUrl'] ?>/img/product/<?php echo $product->productImage->product_image_id . '/' . $product->productImage->product_image_id; ?>.jpg" id="out-of-stock-<?php echo $product->product_id; ?>" class="img-responsive <?php echo $stock->quantity == 0 ? 'out-of-stock' : ''; ?>">
											<?php
											...
											?><img alt="<?php echo $product->brands->brand_name . ' ' . $product->productDetail->name; ?>" src="<?php echo Yii::$app->params['frontendUrl'] ?>/img/product/<?php echo $product->productImage->product_image_id . '/' . $product->productImage->product_image_id; ?>.jpg" class="img-responsive">
