...
#popup-product-wrap, #popup-regraffle-wrap, .zoomContainer {
...
function shopNow() {
    ...
    let URL = 'https://dev.thewatch.co';

    if(p == 'timex'){
        window.location = URL + '/timexraffle?p=open';
...
<?php 
include "../shared/modal-popup-timexraffle.php";
?>

<section style="padding-bottom:2px;padding-top:0 !important;" id="sectionTimexBeam" >
	<video id="my-video" class="video-home" muted loop autoplay loop controls playsinline>

	<source src="https://thewatch.co/img/landing/timexraffle/mobile/vidtimexraffle.mp4" type="video/mp4"/>
...
<section class="nopadding" id="sectionTimexBeam2"> 
	<div class="container" id="containerTimexBeam2">
				...
				<div id="descTimexBeam2">
					<h1 style="font-size:80;">Q TIMEX</h1><h2>1979 REISSUE</h2>
					<p>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="descTimexBeam4">
				...
				<div id="checkoutTimexBeam" class="center-block" style="text-align:center;">
					...
					<a href="#" class="blue-round center-block" id="addtocart" style="float:none;width:200px;margin-top:60px;" onclick="shopNow()">Specs</a>
				</div>
			</div>
		</div>	
	</div>
...
<section id="sectionTimexBeam6">
	<div class="container" id="containerTimexBeam6">
		<div id="descTimexBeam6">
			<p>
				Timex already sold it out on their website last May, but we have a very good news for you all : Q Timex is now available for raffle at thewatch.co on 21 June - 5 July 2019 with limited quota, so you better be fast!
			</p>
			<p>
				Terms & Conditions :<br>
				<ol>
					<li>1 ID card number be allowed for 1 OTP code (OTP code for re-register during the event).</li>
					<li>The Watch Co. is eligible to close the raffle quota before the end of periods when it reach the maximum quota.</li>
					<li>Customer will get email confirmation including an OTP code by filling the registration form below.</li>
					<li>The OTP code cannot be altered & represented.</li>
					<li>The raffle winner will be announced at the event, 11 July 2019</li>
					<li>Each raffle winner proceed to do the payment and show their ID card to cashier and receive the product.</li>
				</ol>
			</p>
			<p>
				Please read carefully our terms and conditions. See you at the event and good luck!
			</p>
		</div>
			<a class="blue-round center-block text-center " style="float:none;width:200px;margin:10% auto;" onclick="registerNow()">Register Now</a>
	</div>
</section>
