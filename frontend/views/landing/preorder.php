...
var dataLayer = [],
    ...
    items.push({
        ...
        "position": <?php echo $i; ?>,
        "list": "Landing Page Pre Order D1 Milano"
    })
    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
				<img src="https://thewatch.co/img/landing/preorder/banner-detail-d1-milano.jpg" class="img-responsive">
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                            
                <div class="brand-name-full" style="font-family: gotham-medium;">
                    PRE-ORDER D1 MILANO
                </div>
                <div class="brand-description">
                    <?php
            $current_date = date('Y-m-d H:i:s');
            if($current_date >= '2018-03-30 00:00:01' && $current_date <= '2018-09-01 23:59:59'){
                ?>
                <span class="gotham-medium">
                    Now is your chance get your hands on the new D1 Milano watch collection! Enjoy 20% off for pre-ordering D1 Milano exclusively available now at The Watch Co.    <br><br>
                    TERMS & CONDITIONS  <br><br>
                </span>
                    
                    <ol>
                        <li>Pre-Order period is until 1 September 2018. Orders after the following date will not be able to purchase with the special pre-order price.</li>
                        <li>You will be charged the full price of the product at the time of placing the Pre-Order. Method of payment accepted is only using bank transfer.</li>
                        <li>Final payments have to be made on 1 September 2018.</li>
                        <li>Estimated time of delivery will be around 4 weeks after the payment date. </li>
      ...
      <!--                  </div>-->
                        ...
                        <?php
                          ...
                          echo Yii::$app->view->renderFile('@app/views/landing/filter_mobile.php', array(
                              "feature" => $feature,
                              "brands" => $brands,
			...
			<?php
            $current_date = date('Y-m-d H:i:s');
            if($current_date >= '2018-08-01 00:00:01' && $current_date <= '2018-09-01 23:59:59'){
      ...
      <div class="container product-box clearleft" style="padding-top:20px;">
        ...
        <div class="row">
          ...
          <?php
              ...
              echo Yii::$app->view->renderFile('@app/views/landing/filter.php', array(
                  "feature" => $feature,
                  "brands" => $brands,
                  "collection_selection" => $collection_selection,
                  "limit"=>$limit,
        ...
        <?php } ?>
                    <div class="hidden-sm col-lg-3 col-md-3 space-product col-xs-6 <?php echo $i % 2 == 0 ? 'pleft75' : 'pright75'; ?> mbottom-3-mobile">
                        <?php
                            ...
                            if($stock != NULL && !$found){
                        ?>
                        <a class="productClick" <?php echo $stock->quantity == 0 ? 'id="out-of-stock" data-id="'.$product->product_id.'"' : ''; ?> href="<?php echo \yii\helpers\Url::base(); ?>/po/<?php echo $product->productDetail->link_rewrite; ?>">
                            <?php } else { ?>
                            <a class="productClick" href="<?php echo \yii\helpers\Url::base(); ?>/po/<?php echo $product->productDetail->link_rewrite; ?>">
                            <?php } ?>
                                ...
                                if ($spesificPrice != null) {
                                    ...
                                    <?php } else { ?>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 product-detail product-price discountview1">
                                            ...
                                            ?>
                                            <?php if(!isset($_COOKIE['currency']) || $_COOKIE['currency'] == "idr"){ ?>
                                            <span class="discount-price-real" style="color:#696969;">IDR <?php echo \common\components\Helpers::getPriceFormat($product->price - $discount); ?></span><br>
                                            <span class="discount-price mleft2 discountview2" style="text-decoration:none;font-size:10px;font-style:unset;">IDR <?php echo \common\components\Helpers::getPriceFormat($product->price); ?></span>
