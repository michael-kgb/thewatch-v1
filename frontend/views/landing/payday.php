        ...
        <div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                ...
                <div class="brand-description">
					...
					1.	Promo dimulai dari periode 25 – 31 Oktober 2019 dan hanya berlaku di halaman ini<br>
					2.	Cicilan 0% kartu kredit berlaku untuk minimum pembelian Rp. 500.000,- dengan tenor 3, 6, dan 12 bulan<br>
					3.	Gratis ongkir ke seluruh Indonesia bisa didapatkan dengan minimum pembelian Rp. 1.000.000,-<br>
					...
					5.	Promo ini tidak bisa digabungkan dengan promo lainnya<br>
					6.	Produk yang sudah dipesan tidak dapat dibatalkan dengan alasan apapun, kecuali terjadi kerusakan dari pabrikan<br>
					7.	Jika transaksi dibatalkan oleh pihak The Watch Co. karena suatu hal (stok habis atau lainnya), dana Anda akan dikembalikan 100% <br>
					8.	Dengan mengikuti promo ini, pengguna dianggap mengerti dan menyetujui semua syarat dan ketentuan yang berlaku<br>
					<br><br>
            ...
            <?php
            if($current_date >= '2019-02-07 00:00:00' && $current_date <= '2019-12-28 23:59:59'){
