    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 clearright pleft-5-dwpetite">
				...
				<div class="brand-description" style="overflow-y: scroll;height: 150px;">
				<?= $data[1]; ?>
				</div>
			</div>
			...
			<section id="breadcrumb" style="padding-top:0px !important;">
				<div class="container">
					<div class="row">
            ...
            <?php
            if($current_date >= '2019-05-04 00:00:00' && $current_date <= '2019-06-01 00:00:00'){
					...
					<?php } ?>
								<div class="hidden-sm col-lg-3 col-md-3 space-product col-xs-6 <?php echo $i % 2 == 0 ? 'pleft75' : 'pright75'; ?> mbottom-3-mobile">
									<?php
										...
										if($stock != NULL && !$found){
									?>
									<a class="productClick" <?php echo $stock->quantity == 0 ? 'id="out-of-stock" data-id="'.$product->product_id.'"' : ''; ?> href="<?php echo \yii\helpers\Url::base(); ?>/product/<?php echo $product->productDetail->link_rewrite; ?>?coupon=OBREDEALS">
										<?php } else { ?>
										<a class="productClick" href="<?php echo \yii\helpers\Url::base(); ?>/product/<?php echo $product->productDetail->link_rewrite; ?>?coupon=OBREDEALS">
										<?php } ?>
										<div style="position:relative;">
                                            ...
                                            <div class="tag-bellow tag-bellow2" style='background-color: #ae4a3b;position: absolute;width: 100%;bottom: 0;top: auto;'>
                                                <div class=''>
                                                    <span class='text-bellow'>
                                                    Use code <u><b>OBREDEALS</b></u> to get 25% Off
