...
var dataLayer = [],
    ...
    items.push({
        ...
        "position": <?php echo $i; ?>,
        "list": "Landing Page Promo Last Call Day Aark Collective"
    })
    ...
    <div class="container">
        <div class="row">
            <?php
                ...
                if($current_date >= '2018-03-30 00:00:01' && $current_date <= '2018-04-29 23:59:59'){
            ?>
            <div class="col-lg-12 clearleft clearright clearleft-mobile clearright-mobile">
                <img src="https://thewatch.co/img/promo/mayday/mayday.jpg" style="width:100%;">
                <div id="day" class="mayday" style=""></div>
                <div id="hour" class="mayday" style=""></div>
                <div id="minute" class="mayday" style=""></div>
                <div id="second" class="mayday" style=""></div>
            </div>
    <style>
        .mayday{
            position: absolute;top: 230px;font-size: 36px;text-align: center;width: 40px;color:rgb(32,97,103);
        }
        #day{
            right: 420px;
        }
        ...
        @media only screen and (min-width : 1000px) and (max-width : 1024px){
            .mayday{ top: 172px;font-size: 28px; }
            #day{ right: 310px; }
            #hour{ right: 242px; }
            #minute{ right: 174px; }
            #second{ right: 109px; }
        ...
        @media only screen and (max-width : 770px){
            .mayday{ top: 131px;font-size: 22px; }
            #day{ right: 235px; }
            #hour{ right: 183px; }
            #minute{ right: 130px; }
            #second{ right: 79px; }
        ...
        @media only screen and (max-width : 700px){
            .mayday{ top: 72px;font-size: 16px; }
            #day{ right: 120px; }
            #hour{ right: 92px; }
            #minute{ right: 63px; }
            #second{ right: 34px; }
        ...
        @media only screen and (max-width : 400px){
            .mayday{ top: 64px;font-size: 14px; }
            #day{ right: 108px; }
            #hour{ right: 81px; }
            #minute{ right: 56px; }
            #second{ right: 28px; }
        ...
        @media only screen and (max-width : 365px){
            .mayday{ top: 63px;font-size: 12px; }
            #day{ right: 104px; }
            #hour{ right: 79px; }
            #minute{ right: 54px; }
            #second{ right: 28px; }
        ...
        @media only screen and (max-width : 330px){
            .mayday{ top: 56px;font-size: 10px; }
            #day{ right: 89px; }
            #hour{ right: 67px; }
            #minute{ right: 45px; }
            #second{ right: 22px; }
...
var countDownDate = new Date("Apr 29, 2018 23:59:59").getTime();
...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        ...
        ?>
            <div class="hidden-lg hidden-xs" style="padding-top:140px;"></div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
                <img src="https://thewatch.co/img/landing/mayday/banner-sale-detail.jpg" class="img-responsive">
            </div>
            <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                ...
                <div class="brand-name-full" style="font-family: gotham-light;">
                    The Watch Co. Mayday Madness 2018!
                </div>
                <div class="brand-description">
                    <?php
            $current_date = date('Y-m-d H:i:s');
            if($current_date > '2018-04-29 23:59:59' && $current_date <= '2018-05-02 23:59:59'){
                ?>
                    Diskon hingga 40% untuk brand Aark Collective, Autodromo, Casio, Design House Stockholms, Hypergrand, Komono, Mockberg, Phase x Voyej, TIMEX, Void Watches, LIMA, dan William L. <br>
Promo berlaku hingga 2 Mei 2018. Beli Sekarang!
            ...
            <section id="product">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 ptop5 pbottom3">
                        <center><span class="gotham-light fsize-1" style="font-size: 25px;"></span></center>
                    </div>
                </div>
            </section>                 
            <?php } ?>
...
<section style="margin-top: 10px;padding-bottom:0px;padding-top:0px;height: 400px;">
        ...
        <div class="container clearleft" style="padding-left:0px;padding-right:0px;">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 clearleft">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gotham-light clearleft clearright" style="text-align: justify;font-size:0.7em;padding-left:0px;padding-right:0px;">
					Pernahkah mendengar istilah Mayday Madness? Bagi yang sering belanja online, mungkin tidak akan asing di telinga Anda. Istilah Mayday Madness digunakan untuk menyambut Hari Buruh Nasional yang jatuh pada tanggal 1 Mei. Mayday Madness merupakan sebuah acara pesta diskon belanja online yang bertujuan untuk memberikan apresiasi kepada semua kalangan buruh atau pekerja di Indonesia tanpa memandang status, jabatan, dan profesi. Kini bagi Anda seorang pekerja bisa menikmati promo khusus untuk mendapatkan harga terbaik setiap pembelian produk di The Watch Co.
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 clearright">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gotham-light clearleft clearright" style="margin-top: 20px;font-size:0.7em;margin-bottom: 10px;padding-left:0px;padding-right:0px;">
				    Manfaatkan Promo Diskon Belanja Online Di Mayday Madness
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gotham-light clearleft clearright" style="text-align: justify;font-size:0.7em;padding-left:0px;padding-right:0px;">
					Kini The Watch Co. turut serta dalam acara Mayday Madness 2018 sebagai bentuk apresiasi kepada semua pekerja di Hari Buruh Nasional. Kami memberikan harga jam tangan terbaik dengan potongan diskon hingga 40%. Promo ini berlaku sangat singkat, oleh karena itu sebaiknya Anda membeli jam tangan pria maupun wanita di momen ini. Kapan lagi bisa beli jam tangan original dengan harga terbaik di Indonesia, ditambah jaminan produk 100% original. Yuk manfaatkan promo diskon belanja online di Mayday Madness 2018 sekarang!
				</div>
			</div>
			<div class="clearfix"></div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 clearleft">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gotham-light clearleft clearright" style="margin-top: 20px;font-size:0.7em;margin-bottom: 10px;padding-left:0px;padding-right:0px;">
					Promo Belanja Online Di Bulan Mei 2018
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gotham-light clearleft clearright" style="text-align: justify;font-size:0.7em;padding-left:0px;padding-right:0px;">
					Di setiap bulan, banyak perusahaan ecommerce yang mengadakan promo belanja online, namun di bulan Mei 2018 ini ada promo istimewa yaitu Mayday Madness. ALasan kenapa disebut istimewa yaitu bulan Mei terdapat momen istimewa memperingati Hari Buruh Nasional lebih tepatnya tanggal 1 Mei 2018. Untuk menikmati promo diskon ini, Anda bisa cek webstie <a href="https://www.thewatch.co/">www.thewatch.co</a>
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 clearright">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gotham-light clearleft clearright" style="margin-top: 20px;font-size:0.7em;margin-bottom: 10px;padding-left:0px;padding-right:0px;">
					Beban Pekerja Menjadi Ringan
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gotham-light clearleft clearright" style="text-align: justify;font-size:0.7em;padding-left:0px;padding-right:0px;">
					Anda sudah berkerja cukup lama tapi masih belum memiliki jam tangan pria dan wanita original? Kini Anda bisa mendapatkannya dengan harga khusus bagi para buruh Indonesia. Kami memberikan harga terbaik jam tangan branded original di Mayday Madness 2018. Nikmati promo tersebut selama 3 hari. Jangan sampai terlewat untuk mendapatkannya. Yuk beli jam tangan original favoritmu sekarang! 
				</div>
			</div>
        </div>
    </div>
    ...
    <div class="hidden-lg hidden-md hidden-sm col-xs-12" id="readmore" style="padding-top: 11px; padding-bottom: 1px; text-align: justify;">
                        <p class="show-read-more">
                            </p><p class="seodesc"><strong