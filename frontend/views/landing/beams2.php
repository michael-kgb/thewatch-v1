...
<section class="nopadding" style="padding-bottom:2px;" id="sectionTimexBeam">
	...
	<source src="https://thewatch.co/img/landing/timexbeams2/vidtimexbeams.mp4" type="video/mp4"/>
...
<section class="nopadding" id="sectionTimexBeam3">
	...
	<img src="https://thewatch.imgix.net/landing/timexbeams2/beams3_2.png?auto=compress" class="img-responsive" width="100%"> 
	...
	<div class="container" id="containerTimexBeam4">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				...
				<img src="https://thewatch.imgix.net/landing/timexbeams2/beams4a_2.png?auto=compress" class="img-responsive">
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="descTimexBeam4">
					...
					<img src="<?php echo \yii\helpers\Url::base(); ?>/img/landing/timexbeams2/product/1.jpg" class="img-responsive img-bordered-shadow center-block" id="image-product">

					<div id="checkoutTimexBeam" class="center-block" style="text-align:center;">

						<h5>TIMEX X BEAMS X ENGINEERED GARMENTS -<br> TW2R56600 36MM</h5>
...
<section class="nopadding" id="sectionTimexBeam5">
	...
	<div class="container" id="containerTimexBeam5">
		...
		<div id="descTimexBeam5">
			...
			<ul style="list-style:none;width:210px;" class="center-block"> 

				<li><label>Water Resistance</label> : 30m</li>

				<li><label>Strap</label> : Black Fabric</li>

				<li><label>Case Color</label> : Silver</li>
				...
				<li><label>Case Material</label> : Stainless steel</li>
...
<section id="sectionTimexBeam6">
	...
	<div class="container" id="containerTimexBeam6">
		...
		<div id="descTimexBeam6">
			...
			<a class="blue-round center-block text-center" style="float:none;width:200px;" href="https://thewatch.co/product/mk1-engineered-garments-x-beams---tw2r56500">Shop Now</a>
...
@media only screen and (min-width: 1024px){
	...
	#sectionTimexBeam2{
		...
		background-image:url('https://thewatch.imgix.net/landing/timexbeams2/beams2a_2.png?auto=compress');
	...
	#sectionTimexBeam5{
		...
		background-image:url('https://thewatch.imgix.net/landing/timexbeams2/beams5_3.png?auto=compress');
...
@media (max-width:1024px){
	...
	#sectionTimexBeam2{
		...
		background-image:url('https://thewatch.imgix.net/landing/timexbeams2/mobile/beams2a_2.png?auto=compress') !important;
	...
	#sectionTimexBeam5{
		...
		background-image:url('https://thewatch.imgix.net/landing/timexbeams2/mobile/beams5_2.png?auto=compress') !important;
