...
<section class="ptop1">
    <div class="container">
        <div class="row">
			...
			?>
			<div class="col-lg-4 col-md-4 hidden-sm hidden-xs clearleft clearright mbottom3">
      
                    <img src="<?= $data[2]; ?>" class="img-responsive">
              
			</div>
			<div class="hidden-lg hidden-md col-sm-4 col-xs-12 clearleft clearright mbottom3">
      
                    <img src="<?= $data[3]; ?>" class="img-responsive">
            ...
            <?php
            if($current_date >= '2019-02-07 00:00:00' && $current_date <= '2019-03-1 00:00:00'){
					...
					<?php } ?>
								<div class="hidden-sm col-lg-3 col-md-3 space-product col-xs-6 <?php echo $i % 2 == 0 ? 'pleft75' : 'pright75'; ?> mbottom-3-mobile">
									...
									<a class="productClick" <?php echo $stock->quantity == 0 ? 'id="out-of-stock" data-id="'.$product->product_id.'"' : ''; ?> href="<?php echo \yii\helpers\Url::base(); ?>/product/<?php echo $product->productDetail->link_rewrite; ?>">
										...
										<?php } ?>
										<div>
											<div class="tag2 circle-discount">
												<?php
                                        ...
                                        ?>
                                          ...
                                          <?php
                                            }else if($product->productNewArrival->product_newarrival_start_date <= $now && $product->productNewArrival->product_newarrival_end_date >= $now){
													?>
