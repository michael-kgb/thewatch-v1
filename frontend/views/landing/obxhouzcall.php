    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
				<img src="https://thewatch.co/img/landing/oliviaburtonxhouzcall/brandbanner.jpg" class="img-responsive">
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite">
				...
				<div class="brand-description">
					Dalam rangka merayakan Hari Ibu Nasional tahun ini, The Watch Co. 
					kini menawarkan gratis voucher Spa Manicure atau Classic Manicure & Pedicure dari Salon Houzcall bernilai IDR 250.000 untuk setiap pembelian produk jam tangan Olivia Burton. 
					Promo ini berlaku dari tanggal 18  hingga 24 Desember 2017*.
					<br><br>
					Saatnya tunjukkan kasih sayangmu dengan memberikan yang terbaik untuk sang Ibu tercinta.
					<br><br>
					*Voucher terbatas untuk 100 pembeli pertama dan khusus untuk pembeli di Jakarta
				</div>
			</div>
                ...
                <div class="container breadcrumb-page">
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-9 breadcrumb-page clearleft clearright">
                            ...
                            <a href="<?php echo \yii\helpers\Url::base() . '/oliviaburtonxhouzcall' . '?' . $params . '&page=1&limit=20'; ?>&sortby=<?php echo $sortby;?>" class="fleft pright2 hidden-xs hidden-sm hidden-md"><span class="gotham-<?php echo!isset($_GET['limit']) || $_GET['limit'] == 20 ? 'medium' : 'light'; ?>">20</span></a>
                            <a href="<?php echo \yii\helpers\Url::base() . '/oliviaburtonxhouzcall' . '?' . $params . '&page=1&limit=40'; ?>&sortby=<?php echo $sortby;?>" class="fleft pright2 hidden-xs hidden-sm hidden-md"><span class="gotham-<?php echo isset($_GET['limit']) && $_GET['limit'] == 40 ? 'medium' : 'light'; ?>">40</span></a>
                            <a href="<?php echo \yii\helpers\Url::base() . '/oliviaburtonxhouzcall' . '?' . $params . '&page=1&limit=60'; ?>&sortby=<?php echo $sortby;?>" class="fleft pright2 hidden-xs hidden-sm hidden-md"><span class="gotham-<?php echo isset($_GET['limit']) && $_GET['limit'] == 60 ? 'medium' : 'light'; ?>">60</span></a>
						</div>
                        <div class="col-lg-3 show-number clearright clearleft" style="text-align: left;width: 21%;float: right;    line-height: 32px;">
                            ...
                            <div class="clearleft clearright hidden-xs hidden-sm hidden-md hidden-lg-4" style="display: inline;">
                                ...
                                <div class="hidden-xs sorting-box" id="box-sorting">
                                    <a class="sorting-list top" href="<?php echo \yii\helpers\Url::base() . '/oliviaburtonxhouzcall' . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=none'; ?>">BRANDS NAME</a>
                                    <a class="sorting-list" id="sorting-none" href="<?php echo \yii\helpers\Url::base() . '/oliviaburtonxhouzcall' . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=price-low-to-high'; ?>">PRICE LOW TO HIGH</a>
                                    <a class="sorting-list bottom" href="<?php echo \yii\helpers\Url::base() . '/oliviaburtonxhouzcall' . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=price-high-to-low'; ?>">PRICE HIGH TO LOW</a>
                                </div>
                            </div>
                            <style type="text/css">
                        ...
                        <div class="hidden-lg hidden-md col-xs-12 remove-padding" style="display: none; position: fixed; width: 100%; height: 100%; left: 0; top: 0px; background: #f6f6f6; z-index: 10; overflow: auto" id="sorting-content">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <a href="<?php echo \yii\helpers\Url::base() . '/oliviaburtonxhouzcall' . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=none'; ?>">
                                ...
                                <a href="<?php echo \yii\helpers\Url::base() . '/oliviaburtonxhouzcall' . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=price-low-to-high'; ?>">
                                    <div class="col-xs-12 padding-bottom-3 border-bottom-1 margin-top-3 remove-padding-left remove-padding-right" style="padding-top:8px;">
                                ...
                                <a href="<?php echo \yii\helpers\Url::base() . '/oliviaburtonxhouzcall' . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=price-high-to-low'; ?>">
                                    <div class="col-xs-12 padding-bottom-3 border-bottom-1 margin-top-3 remove-padding-left remove-padding-right" style="padding-top:8px;">
            ...
            if($current_date >= '2017-12-18 00:00:00' && $current_date <= '2017-12-24 23:59:59'){
										...
										<div>
											...
											<?php
												...
												?>
													...
													?>
														 <div class="tag-bellow tag-bellow2" style='background-color: #4c757b;'>
															<div class=''>
																<span class='text-bellow'>
																New Arrival
