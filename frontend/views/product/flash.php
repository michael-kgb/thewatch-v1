        ...
        <div class="row">
                                ...
                                <ul id="thumb-small">
                                    ...
                                    <?php foreach ($productImages as $image) { ?>
                                        ...
                                        <?php if(count($productImages)-1 == $img_seq){ ?>
                                            <?php if($product->product_id == 2263 || $product->product_id == 2278 || $product->product_id == 2317 || $product->product_id == 2416 || $product->product_id == 2431){?>
                                                <li class="small-thumb" id="<?php echo $attributeId; ?>" data-image="<?php echo Yii::$app->params['imgixUrl'] ?>product/<?php echo $image->product_image_id . '/' . $image->product_image_id; ?>_medium.jpg?auto=compress,format&fit=max&fm=jpg&lossless=true" data-zoom-image="<?php echo Yii::$app->params['imgixUrl'] ?>product/<?php echo $image->product_image_id . '/' . $image->product_image_id; ?>_big.jpg?auto=compress,format&fit=max&fm=jpg&lossless=true">
                                        ...
                                        <?php } ?>
                                        <li class="small-thumb" id="<?php echo $attributeId; ?>" data-image="<?php echo Yii::$app->params['imgixUrl'] ?>product/<?php echo $image->product_image_id . '/' . $image->product_image_id; ?>_medium.jpg?auto=compress,format&fit=max&fm=jpg&lossless=true" data-zoom-image="<?php echo Yii::$app->params['imgixUrl'] ?>product/<?php echo $image->product_image_id . '/' . $image->product_image_id; ?>_big.jpg?auto=compress,format&fit=max&fm=jpg&lossless=true">
                                            <a href="#" onclick="video_stop_product();" class="small-thumb" id="<?php echo $attributeId; ?>" data-image="<?php echo Yii::$app->params['imgixUrl'] ?>product/<?php echo $image->product_image_id . '/' . $image->product_image_id; ?>_medium.jpg?auto=compress,format&fit=max&fm=jpg&lossless=true" data-zoom-image="<?php echo Yii::$app->params['imgixUrl'] ?>product/<?php echo $image->product_image_id . '/' . $image->product_image_id; ?>_big.jpg?auto=compress,format&fit=max&fm=jpg&lossless=true">
                                                <img alt="<?php echo $product->brands->brand_name . ' ' . $product->productDetail->name; ?>" src="<?php echo Yii::$app->params['imgixUrl'] ?>product/<?php echo $image->product_image_id . '/' . $image->product_image_id; ?>_small.jpg?auto=compress,format&fit=max&fm=jpg&lossless=true" class="img-responsive">
                                            </a>
                                        </li>
                                        <?php $img_seq++;?>
                                    <?php } ?>
                        ...
                        <?php if (count($productImages) > 0) { ?>
                            <?php foreach ($productImages as $banner) { ?>
                                ...
                                <div class="item <?php echo $i === 1 ? 'active' : ''; ?>">
                                    <img src="<?php echo Yii::$app->params['imgixUrl'] ?>product/<?php echo $banner->product_image_id . '/' . $banner->product_image_id . "_big.jpg?auto=compress,format&fit=max&fm=jpg&lossless=true"; ?>" class="img-responsive">
                                    <!--<div class="fill" style="background-image: url(<?php // echo Yii::$app->params['imgixUrl'] ?>product/<?php // echo $banner->product_image_id . '/' . $banner->product_image_id . "_big.jpg?auto=compress,format&fit=max&fm=jpg&lossless=true"; ?>);"></div>-->
                                </div>
                                <?php $i++; ?>
                            <?php } ?>
                            <?php if($product->product_id == 1701 || $product->product_id == 1997 || $product->product_id == 2259 || $product->product_id == 2260 || $product->product_id == 2415){?>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 clearleft-ipad">
                ...
                if ($spesificPriceAll != null) {
                    ...
                    <?php
                        foreach ($spesificPriceAll as $spesificPrice) {
							$reduction = $spesificPrice->reduction;
                    ?>
                        ...
                        <?php } else { ?>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 product-detail product-name">
                                ...
                                if ($spesificPrice->reduction_type == 'percent') {
                                    ...
                                    $discount = floor( ($spesificPrice->reduction / 100) * $product->price );
									$discount_amount = $product->price - $discount;
									if($reduction_extra > 0){
                                        // set discount extra
                                        // $discount = floor( ($spesificPrice->reduction / 100) * $product->price );
                                        $hrg_akhir = $product->price - $discount;
                                        $disc_xtra = floor( ($reduction_extra / 100) * $hrg_akhir );
                                        $total_price = $hrg_akhir - $disc_xtra;
										$discount_extra = $disc_xtra;
										$discount_amount_extra = $total_price;
										
										if($reduction_plus_extra > 0){
											 // set discount plus extra
											 // $discount = floor( ($spesificPrice->reduction / 100) * $product->price );
											 $hrg_akhir = $product->price - $discount;
											 $disc_xtra = floor( ($reduction_extra / 100) * $hrg_akhir );
											 $hrg_final = $hrg_akhir - $disc_xtra;
											 $disc_super_xtra = floor( ($reduction_plus_extra / 100) * $hrg_final );
											 $hrg_fix = $hrg_final - $disc_super_xtra;
											 $total_price = $hrg_fix;
											 $discount_plus_extra = $disc_super_xtra;
											 $discount_amount_plus_extra = $total_price;
										}
									}
                                    else{
                                        $discount = floor(($spesificPrice->reduction / 100) * $product->price);
                                ...
                                ?>
                                IDR <?php echo \common\components\Helpers::getPriceFormat($total_price); ?>
                                ...
                                <input type="hidden" class="disc" name="disc" value="<?php echo $reduction; ?>">
                                <input type="hidden" class="discount" name="discount" value="<?php echo $discount; ?>">
                                <input type="hidden" class="discount_amount" name="discount_amount" value="<?php echo $discount_amount; ?>">
                                <input type="hidden" class="disc_extra" name="disc_extra" value="<?php echo $reduction_extra; ?>">
                                <input type="hidden" class="discount_extra" name="discount_extra" value="<?php echo $discount_extra; ?>">
                                <input type="hidden" class="discount_amount_extra" name="discount_amount_extra" value="<?php echo $discount_amount_extra; ?>">
                                <input type="hidden" class="disc_plus_extra" name="disc_plus_extra" value="<?php echo $reduction_plus_extra; ?>">
                                <input type="hidden" class="discount_plus_extra" name="discount_plus_extra" value="<?php echo $discount_plus_extra; ?>">
                                <input type="hidden" class="discount_amount_plus_extra" name="discount_amount_plus_extra" value="<?php echo $discount_amount_plus_extra; ?>">
                ...
                <div class="hidden-xs col-lg-12 col-md-12 col-sm-12 product-detail product-total">
                    ...
                    <span class="product-total">IDR <?php echo \common\components\Helpers::getPriceFormat($total_price); ?></span>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 product-detail product-select" style="<?php echo $flash_item == 1 ? 'display: none;':''; ?>">
                    ...
                    <?php } else { ?>
                        ...
                        <div class="clearleft clearright" id="qty">
                            <select class="qty margin-bottom-5" name="qty">
                                <option value="0">Jumlah</option>
...
//                            $productStock = \backend\models\ProductStock::findOne(["product_id" => $id]);
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 hidden-xs product-detail share-box socmed clearleft" style="line-height: 50px;">
                    ...
                    <div style="line-height: 62px;">
                        ...
                        ?>
                        <!-- picture=http://thewatch.co/product/<?php echo $image_cover->product_image_id; ?>/<?php echo $image_cover->product_image_id; ?>_medium.jpg?auto=compress,format&fit=max&fm=jpg&lossless=true -->
                ...
                <?php } ?>
                <?php } ?>                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 product-detail clearright clearleft-mobile clearright-mobile" style="padding-top: 20px;">
