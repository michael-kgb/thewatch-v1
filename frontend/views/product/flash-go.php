                        ...
                        <?php } else { ?>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 product-detail product-name">
                                ...
                                if ($spesificPrice->reduction_type == 'percent') {
                                    ...
                                    if( ($now > '2019-02-01 08:00:00') && ($now <= '2019-02-01 10:00:00') ){
                                        // set discount + 10%
                                        $discount = floor( ($spesificPrice->reduction / 100) * $product->price );
                                        $hrg_akhir = $product->price - $discount;
                                        $disc_xtra = floor( (10 / 100) * $hrg_akhir );
                                        $total_price = $hrg_akhir - $disc_xtra;
                                    }elseif( ($now > '2019-02-01 10:00:00') && ($now <= '2019-02-01 17:00:00') ){
                                         // set discount + 10% + 5%
                                         $discount = floor( ($spesificPrice->reduction / 100) * $product->price );
                                         $hrg_akhir = $product->price - $discount;
                                         $disc_xtra = floor( (10 / 100) * $hrg_akhir );
                                         $hrg_final = $hrg_akhir - $disc_xtra;
                                         $disc_super_xtra = floor( (5 / 100) * $hrg_final );
