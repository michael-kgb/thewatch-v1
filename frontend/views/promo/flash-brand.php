			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearleft clearright mbottom3">
				<div class="thumbnail-flash-sale">
					<a data-toggle="modal" data-target="#flashModal" style="cursor: pointer;">
						<img src="http://thewatch.imgix.net/promo/flash/Flash%20Sale%2011%20Mei_Sale%20banner%20(D).jpg?auto=compress" data-was-processed="true" class="img-responsive hidden-xs" style="display: block;margin: auto;">
						<img src="http://thewatch.imgix.net/promo/flash/Flash%20Sale%2011%20Mei_Sale%20banner%20(M).jpg?auto=compress" data-was-processed="true" class="img-responsive hidden-lg hidden-md hidden-sm" style="display: block;margin: auto;">
      ...
      <div class="modal-body title-warranty" style="padding-left:0;padding-right:0;margin-top:10px;padding-top:5px;height:240px;">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearleft clearright clearleft-mobile clearright-mobile talign-left gotham-light">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 new-line"></div>
                <ol>
                    <li>Promo hanya berlaku 11 Mei 2020, hanya di halaman ini</li>
                    <li>Pembayaran hanya bisa dilakukan dengan Virtual Account, Kartu Kredit, Akulaku, Vospay, dan Kredivo</li>
