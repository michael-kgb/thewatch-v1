...
<section class="ptop1">
    <div class="container">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ptop2 remove-padding clearleft clearright">
                    <div class='col-lg-12 col-md-12 col-sm-12 ptop2 col-xs-12 remove-padding-left remove-padding-right clearleft clearright'>
                        <a href="<?php echo \yii\helpers\Url::base(); ?>/hgbundling">
                            <img src='<?php echo \yii\helpers\Url::base(); ?>/img/promo/endsale/banner_hgbundling.jpg' class="img-responsive">
                        </a>
                    </div>
        ...
        <?php $form = ActiveForm::begin(['action' => \yii\helpers\Url::base() . '/hgbundling', "id" => "hgbundling-form"]) ?>
        <div class="row mtop5">
                        ...
                        <?php } ?>   
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mbottom20">
                                <a target="_blank" href="<?php echo \yii\helpers\Url::base(); ?>/product/<?php echo $product->productDetail->link_rewrite; ?>">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 product gotham-light product-price">IDR <?php echo \common\components\Helpers::getPriceFormat($product->price); ?></div>
                                    ...
                                    if($stock != NULL){
                                        if($stock->quantity <= 0){
                                    ?>
                                    <div class="col-lg-12 col-md-12 col-sm-12 product gotham-light product-name clearleft clearright mtop2"><input type="radio" name="hgwatches[]" disabled></div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 product gotham-light product-name clearleft clearright">OUT OF STOCK</div>
                                        <?php } else { ?>
                                    <div class="col-lg-12 col-md-12 col-sm-12 product gotham-light product-name clearleft clearright mtop2"><input type="radio" name="hgwatches[]" value="<?php echo $product->product_id; ?>"></div>
