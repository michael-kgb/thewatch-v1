    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
				...
				<img src="https://thewatch.co/img/promo/september/Sale-Banner-Detail.jpg" class="img-responsive">
				
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                            
                <h1 class="brand-name-full m0 gotham-light">
                    Promo Everyday is Payday with GO-PAY
            ...
            if($current_date >= '2018-03-30 00:00:01' && $current_date <= '2018-12-31 23:59:59'){
                ?>
                    Nikmati promo spesial Everyday is Payday with GO-PAY untuk produk pilihan.
    				
                        <br>
                    Syarat dan ketentuan: <br>
                    <ol>
                        <li>Diskon 50% tanpa minimum transaksi</li>
                        <li>Maksimum diskon Rp50,000</li>
                        <li>Berlaku untuk transaksi menggunakan GO-PAY</li>
                        <li>Berlaku dari tanggal 23 September - 31 Desember 2018</li>
                        <li>Untuk 40 transaksi pertama setiap harinya</li>
                        <li>Promo berlaku hanya satu kali dalam sehari untuk setiap pengguna GO-PAY </li>
                    </ol>
      ...
      <!--                  </div>-->
			...
			<?php
            $current_date = date('Y-m-d H:i:s');
            if($current_date >= '2018-08-01 00:00:01' && $current_date <= '2018-12-31 23:59:59'){
...
<section class="" style="padding-top:0px;"></section>
<!--SEO Pages-->
