            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearleft clearright pbottom5 salebrandbannerview">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ptop2 remove-padding clearleft clearright ">
                    <div class='col-lg-12 col-md-12 col-sm-12 ptop2 col-xs-12 remove-padding-left remove-padding-right clearleft clearright'>
                        <a href="<?php echo \yii\helpers\Url::base(); ?>/valentine/forhim">
                            <img src='<?php echo \yii\helpers\Url::base(); ?>/img/promo/valentine/Valentine-03.jpg' class="img-responsive">
                        </a>
                    </div>                    
                </div>
            </div>
                ...
                <div class="container breadcrumb-page">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 breadcrumb-page clearleft clearright">
                            ...
                            <a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?page=1&limit=20'; ?>" class="fleft pright2 hidden-xs hidden-sm hidden-md"><span class="gotham-<?php echo!isset($_GET['limit']) || $_GET['limit'] == 20 ? 'medium' : 'light'; ?>">20</span></a>
                            <a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?page=1&limit=40'; ?>" class="fleft pright2 hidden-xs hidden-sm hidden-md"><span class="gotham-<?php echo isset($_GET['limit']) && $_GET['limit'] == 40 ? 'medium' : 'light'; ?>">40</span></a>
                            <a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?page=1&limit=60'; ?>" class="fleft pright2 hidden-xs hidden-sm hidden-md"><span class="gotham-<?php echo isset($_GET['limit']) && $_GET['limit'] == 60 ? 'medium' : 'light'; ?>">60</span></a>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearleft clearright">
                    <div class="hidden-lg col-md-8 col-sm-8 col-xs-6 remove-padding clearleft pleftpagemobilepag2">
                        ...
                        <span class="gotham-<?php echo!isset($_GET['limit']) || $_GET['limit'] == 20 ? 'medium' : 'light'; ?> padd-4 position-left">
                            <a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?page=1&limit=20'; ?>">20</a>
                        </span>
                        <span class="gotham-<?php echo isset($_GET['limit']) && $_GET['limit'] == 40 ? 'medium' : 'light'; ?> padd-4 position-left">
                            <a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?page=1&limit=40'; ?>">40</a>
                        </span>
                        <span class="gotham-<?php echo isset($_GET['limit']) && $_GET['limit'] == 60 ? 'medium' : 'light'; ?> padd-4 position-left">
                            <a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?page=1&limit=60'; ?>">60</a>
                        </span>
                    </div>
						...
						?>
							<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-2 fright right-float clearright pleftpage0 clearrightcopy pleftpagemobilepag1">
								<span class="gotham-medium pleft13-5 remove-padding">
									<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=1&amp;limit=20">1</a>
								</span>
								<span class="gotham-light pleft13-5 pleft-mobile-4">
									<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=2&amp;limit=20">2</a>
								</span>
								<span class="hidden-sm hidden-xs gotham-light pleft13-5 pleft-mobile-4">
									<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=2&amp;limit=20">NEXT</a>
								</span>
								<span class="hidden-lg hidden-mdgotham-light pleft13-5 pleft-mobile-4 nexticonpagin">
									<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=2&amp;limit=20"><img src="<?php echo \yii\helpers\Url::base(); ?>/img/icons/next.png" class="nexticonpagin"></a>
								</span>
							</div>
						<?php 
						...
						?>
							...
							?>
								<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-2 fright right-float clearright">
									...
									<span class="gotham-medium pleft13-5 remove-padding">
										<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=1&amp;limit=<?php echo $_GET['limit']; ?>">1</a>
									</span>
									<span class="gotham-light pleft13-5 pleft-mobile-4">
										<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=2&amp;limit=<?php echo $_GET['limit']; ?>">2</a>
									</span>
									<span class="gotham-light pleft13-5 pleft-mobile-4">
										<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=2&amp;limit=<?php echo $_GET['limit']; ?>">NEXT</a>
									</span>
								</div>
							<?php 
							} else { 
							?>
								<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-2 fright right-float clearright pleftpage0 clearrightcopy pleftpagemobilepag1">
									...
									<span class="gotham-medium pleft13-5 remove-padding">
										<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=1&amp;limit=<?php echo $_GET['limit']; ?>">1</a>
									</span>
									<span class="gotham-light pleft13-5 pleft-mobile-4">
										<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=2&amp;limit=<?php echo $_GET['limit']; ?>">2</a>
									</span>
									<span class="hidden-sm hidden-xs gotham-light pleft13-5 pleft-mobile-4">
										<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=2&amp;limit=<?php echo $_GET['limit']; ?>">NEXT</a>
									</span>
									<span class="hidden-lg hidden-md gotham-light pleft13-5 pleft-mobile-4">
										<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=2&amp;limit=<?php echo $_GET['limit']; ?>"><img src="<?php echo \yii\helpers\Url::base(); ?>/img/icons/next.png" class="nexticonpagin"></a>
									</span>
								</div>
							<?php 
							} 
								...
								?>
									<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-1 fright right-float clearright">
										<span class="gotham-light pleft18 remove-padding">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=<?php echo $_GET['page'] - 1; ?>&amp;limit=<?php echo $_GET['limit']; ?>">PREV</a>
										</span>
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=<?php echo $current - 1; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current - 1; ?></a>
										</span>
										<span class="gotham-medium pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=<?php echo $current; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current; ?></a>
										</span>
									</div>
								<?php 
								}
								...
								?>
									<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-1 fright right-float clearright pleftpage2 pleftpagemobilepag1">
										<span class="hidden-sm hidden-xs gotham-light pleft43 remove-padding">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $_GET['page'] - 1; ?>&amp;limit=<?php echo $_GET['limit']; ?>">PREV</a>
										</span>
										<span class="hidden-lg hidden-md gotham-light pleft43 remove-padding">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $_GET['page'] - 1; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><img src="<?php echo \yii\helpers\Url::base(); ?>/img/icons/prev.png" class="nexticonpagin"></a>
										</span>
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $current - 1; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current - 1; ?></a>
										</span>
										<span class="gotham-medium pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $current; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current; ?></a>
										</span>
									</div>  
								<?php 
								} 
					...
					?>
						...
						?>
							<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-2 fright right-float clearright pleftpage0 clearrightcopy pleftpagemobilepag1">
								...
								<span class="gotham-light pleft13-5 pleft-mobile-4">
									<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=3&amp;limit=20">3</a>
								</span>
								<span class="hidden-sm hidden-xs gotham-light pleft13-5 pleft-mobile-4">
									<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=2&amp;limit=20">NEXT</a>
								</span>
						...
						?>
							...
							?>
								<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-2 fright right-float clearright">
									...
									<span class="gotham-light pleft13-5 pleft-mobile-4">
										<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=3&amp;limit=<?php echo $_GET['limit']; ?>">3</a>
									</span>
									<span class="gotham-light pleft13-5 pleft-mobile-4">
										<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=2&amp;limit=<?php echo $_GET['limit']; ?>">NEXT</a>
									</span>
							...
							?>
								<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-2 fright right-float clearright pleftpage0 clearrightcopy pleftpagemobilepag1">
									...
									<span class="gotham-light pleft13-5 pleft-mobile-4">
										<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=3&amp;limit=<?php echo $_GET['limit']; ?>">3</a>
									</span>
									<span class="hidden-sm hidden-xs gotham-light pleft13-5 pleft-mobile-4">
										<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=2&amp;limit=<?php echo $_GET['limit']; ?>">NEXT</a>
									</span>
							...
							?>
								...
								?>
									<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-1 fright right-float clearright">
										...
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=<?php echo $_GET['page'] + 1; ?>&amp;limit=<?php echo $_GET['limit']; ?>">NEXT</a>
										</span>
									</div>
								<?php 
								} else { 
										...
										?>
											<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-1 fright right-float clearright pleftpage2 pleftpagemobilepag1">
												...
												<span class="hidden-sm hidden-xs gotham-light pleft8-5ver2 pleft-mobile-4">
													<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $_GET['page'] + 1; ?>&amp;limit=<?php echo $_GET['limit']; ?>">NEXT</a>
												</span>
												<span class="hidden-lg hidden-md gotham-light pleft8-5ver2 pleft-mobile-4">
													<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $_GET['page'] + 1; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><img src="<?php echo \yii\helpers\Url::base(); ?>/img/icons/next.png" class="nexticonpagin"></a>
												</span>
											</div>
										<?php 
										}
							...
							?>
								...
								?>
									<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-1 fright right-float clearright">
										...
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=<?php echo $current - 2; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current - 2; ?></a>
										</span>
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=<?php echo $current - 1; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current - 1; ?></a>
										</span>
								...
								?>
									<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-1 fright right-float clearright pleftpage2 pleftpagemobilepag1">
										...
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $current - 2; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current - 2; ?></a>
										</span>
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $current - 1; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current - 1; ?></a>
										</span>
					...
					?>
						...
						?>
							<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-2 fright right-float clearright pleftpage0 clearrightcopy pleftpagemobilepag1">
								...
								<span class="hidden-sm hidden-xs gotham-light pleft13-5 pleft-mobile-4">
									<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=4&amp;limit=20">4</a>
								</span>
								<span class="hidden-sm hidden-xs gotham-light pleft13-5 pleft-mobile-4">
									<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=2&amp;limit=20">NEXT</a>
								</span>
						...
						?>
							...
							?>
								<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-2 fright right-float clearright">
									...
									<span class="gotham-light pleft13-5 pleft-mobile-4">
										<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=3&amp;limit=<?php echo $_GET['limit']; ?>">4</a>
									</span>
									<span class="gotham-light pleft13-5 pleft-mobile-4">
										<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=2&amp;limit=<?php echo $_GET['limit']; ?>">NEXT</a>
									</span>
							...
							?>
								<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-2 fright right-float clearright pleftpage0 clearrightcopy pleftpagemobilepag1">
									...
									<span class="hidden-sm hidden-xs gotham-light pleft13-5 pleft-mobile-4">
										<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=4&amp;limit=<?php echo $_GET['limit']; ?>">4</a>
									</span>
									<span class="hidden-sm hidden-xs gotham-light pleft13-5 pleft-mobile-4">
										<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=2&amp;limit=<?php echo $_GET['limit']; ?>">NEXT</a>
									</span>
							...
							?>
								...
								?>
									<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-1 fright right-float clearright">
										...
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=<?php echo $current - 3; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current - 3; ?></a>
										</span>
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim' . '?' . $params; ?>&page=<?php echo $current - 2; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current - 2; ?></a>
										</span>
								...
								?>
									<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-1 fright right-float clearright pleftpage2 pleftpagemobilepag1">
										...
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $current - 3; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current - 3; ?></a>
										</span>
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $current - 2; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current - 2; ?></a>
										</span>
					...
					?>
						...
						?>
							<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-2 fright right-float clearright pleftpage0 clearrightcopy pleftpagemobilepag1">
								...
								<span class="hidden-sm hidden-xs gotham-light pleft13-5 pleft-mobile-4">
									<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=5&amp;limit=20">5</a>
								</span>
								<span class="hidden-lg hidden-md gotham-light pleftmaxbotton remove-padding">
									..
								</span>
								...
								<span class="hidden-sm hidden-xs gotham-light pleft13-5 remove-padding">
									<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $total_page;?>&amp;limit=20"><?php echo $total_page;?></a>
								</span>
						...
						?>
							...
							?>
								<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-2 fright right-float clearright pleftpage0 clearrightcopy pleftpagemobilepag1">
									...
									<span class="hidden-sm hidden-xs gotham-light pleft13-5 pleft-mobile-4">
										<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=5&amp;limit=<?php echo $_GET['limit']; ?>">5</a>
									</span>
									<span class="hidden-lg hidden-md gotham-light pleftmaxbotton remove-padding">
										..
									</span>
									...
									<span class="gotham-light pleft13-5 pleft-mobile-4">
										<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $total_page;?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $total_page;?></a>
									</span>
									<span class="hidden-sm hidden-xs gotham-light pleft13-5 pleft-mobile-4">
										<a class="mright3" href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=2&amp;limit=<?php echo $_GET['limit']; ?>">NEXT</a>
									</span>
										...
										?>
											<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-1 fright right-float clearright pleftpage2 pleftpagemobilepag1">
												...
												<span class="hidden-sm hidden-xs gotham-light pleft8-5 pleft-mobile-4">
													<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $total_page - 4; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $total_page - 4; ?></a>
												</span>
												<span class="hidden-sm hidden-xs gotham-light pleft8-5 pleft-mobile-4">
													<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $total_page - 3; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $total_page - 3; ?></a>
												</span>
												<span class="gotham-light pleft8-5 pleft-mobile-4">
													<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $total_page - 2; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $total_page - 2; ?></a>
												</span>
												<span class="gotham-medium pleft8-5 pleft-mobile-4">
													<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $current; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current; ?></a>
												</span>
							...
							?>
								...
								?>
									<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 remove-padding text-to-right col-lg-offset-1 fright right-float clearright pleftpage2 pleftpagemobilepag1">
										...
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $current - 4; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current - 4; ?></a>
										</span>
										<span class="gotham-light pleft8-5 pleft-mobile-4">
											<a href="<?php echo \yii\helpers\Url::base() . '/valentine/forhim'; ?>?page=<?php echo $current - 3; ?>&amp;limit=<?php echo $_GET['limit']; ?>"><?php echo $current - 3; ?></a>
										</span>
