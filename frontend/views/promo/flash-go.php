...
<?php
    ...
    $link_btn1 = "/".$page_url."?batch=1";
    $link_btn2 = "/".$page_url."?batch=2";
    $link_btn3 = "/".$page_url."?batch=3";
    $link_btn4 = "/".$page_url."?batch=4";
...
<section style="padding-top:25;padding-bottom:25;">
    <div class="container">
        ...
        $date_today_2 = $end_date." ".$start_batch[1]." - ".$end_batch[1];
            // Setting Button Time			
			if(count($arr_batch) > 2){
        ...
        ?>
			...
			<section style="padding-top:20px;padding-bottom:20px;">
				<div class="col-lg-12 col-md-12 hidden-xs col-sm-12 clearleft clearright" style="padding-bottom:20px;">
					<div class="col-lg-6 clearleft pright75"><a href="<?php echo $link_btn1; ?>" class="flash-button <?php echo $button1 == 1 ? 'active':'' ?>"><?php echo $date_today_1; ?></a></div>
					<div class="col-lg-6 clearleft pright75"><a href="<?php echo $link_btn2; ?>" class="flash-button <?php echo $button2 == 1 ? 'active':'' ?>"><?php echo $date_today_2; ?></a></div>
				</div>
				<div class="swiper-flash-menu-mobile col-xs-12 hidden-lg hidden-md hidden-sm" style="padding-bottom:20px;overflow-y:hidden;">
					<div class="swiper-wrapper">
						<div class="col-lg-6 clearleft pright75"><a href="<?php echo $link_btn1; ?>" class="flash-button <?php echo $button1 == 1 ? 'active':'' ?> text-small"><?php echo $date_today_1; ?></a></div>
						<div class="col-lg-6 clearleft pright75"><a href="<?php echo $link_btn2; ?>" class="flash-button <?php echo $button2 == 1 ? 'active':'' ?> text-small"><?php echo $date_today_2; ?></a></div>
					</div>
				</div>
			</section>
				...
				<div class="row">
					...
					<?php
						...
						foreach ($products as $product) {
							...
							$found = FALSE;
                            $stockall = 0;
                            $link_product = \yii\helpers\Url::base()."/flash-go/".$product->productDetail->link_rewrite;
      ...
      <div class="modal-body title-warranty" style="padding-left:0;padding-right:0;margin-top:10px;padding-top:5px;height:240px;">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearleft clearright clearleft-mobile clearright-mobile talign-left gotham-light">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 new-line"></div>
                <ol>
                    <li>Promo dimulai dari periode 27 - 28 Maret 2019, pukul 11.00 – 15.00 WIB</li>
                    <li>Untuk menikmati promo The Watch Co. Festival hanya berlaku di halaman flash sale</li>
					...
					<li>Gratis ongkir ke seluruh Indonesia bisa didapatkan dengan minimum pembelian Rp. 1.000.000,-</li>
					...
					<li>Promo ini tidak bisa digabungkan dengan promo lainnya</li>
