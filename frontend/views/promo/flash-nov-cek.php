    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
				...
				<img src="https://thewatch.co/img/promo/flash/11_11_19/11.11_Detail Banner.jpg" class="img-responsive">
            ...
            if($current_date >= '2019-11-01 00:00:00' && $current_date <= '2019-12-31 23:59:59'){ 
                ?>
Berbagi waktu adalah salah satu program The Watch Co. untuk memberikan promo spesial berupa potongan harga dengan cara setiap pembelian 1 produk dengan harga normal, maka akan mendapatkan setengah harga untuk pembelian 1 produk berikutnya.<br><br>
Syarat dan Ketentuan:<br>
1.	Gunakan kode voucher: TWCBERBAGI untuk menikmati promo ini<br>
2.	Promo hanya bisa digunakan untuk produk yang ada di halaman ini<br>
3.	Promo ini tidak bisa digabungkan dengan promo lainnya<br>
4.	Cicilan kartu kredit minimum pembayaran sebesar Rp. 500.000,- dengan tenor 3, 6, dan 12 bulan<br>
5.	Promo berlaku tanggal 7 - 30 November 2019<br>
        ...
        <?php } ?>
                    <div class="hidden-sm col-lg-3 col-md-3 space-product col-xs-6 <?php echo $i % 2 == 0 ? 'pleft75' : 'pright75'; ?> mbottom-3-mobile">
                        ...
                        <a class="productClick" <?php echo $stock->quantity == 0 ? 'id="out-of-stock" data-id="'.$product->product_id.'"' : ''; ?> href="<?php echo \yii\helpers\Url::base(); ?>/product/<?php echo $product->productDetail->link_rewrite; ?>">
                            ...
                            <div style="position:relative;">
                                <div class="tag">
                                    ...
                                    if (!empty($product->specificPrice)) {
                                        if ($product->specificPrice->from >= "2019-11-11 11:11:00" && $product->specificPrice->to <= "2019-11-13 15:00:00") {
                                            ?>
							...
							<span style="font-size:12px;"><?=$product->specificPrice->from?> | <?=$product->specificPrice->to?> </span><br>
                            ...
                            <?php
                                ...
                                if ($spesificPrice != null) {
                                    ?> 
                                    <?php if ($product->specificPrice->from < "2019-11-11 11:11:00" && $product->specificPrice->to > "2019-11-13 15:00:00") { ?>
            ...
            <?php } ?>
                    <div class="col-sm-4 <?php echo $i % 2 == 0 ? 'pleft75' : 'pright75'; ?>">
                        ...
                        <a class="productClick" <?php echo $stock->quantity == 0 ? 'id="out-of-stock" data-id="'.$product->product_id.'"' : ''; ?> href="<?php echo \yii\helpers\Url::base(); ?>/product/<?php echo $product->productDetail->link_rewrite; ?>">
                            ...
                            <input type="hidden" name="productCategory" value="<?php echo $product->productCategory->product_category_name; ?>">
                            <input type="hidden" name="productPosition" value="<?php echo $i; ?>">
							<span style="font-size:8px;"><?=$product->specificPrice->from?> | <?=$product->specificPrice->to?> </span>
                            <div class="col-lg-12 col-md-12 col-sm-12 product brand-titlebrand-title"><?php echo strtoupper($product->brands->brand_name); ?></div>
                            <div class="col-lg-12 col-md-12 col-sm-12 product product-name"><span class="lspace0-5"><?php echo ucwords($product->productDetail->name); ?></span></div>
                            <?php
                                // if product has discount
                                $spesificPrice = backend\models\SpecificPrice::findOne(['product_id' => $product->product_id]);
