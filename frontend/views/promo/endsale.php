        ...
        <div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearleft clearright mbottom3">
			    <div class="col-lg-12 col-md-12 col-sm-12 hidden-xs clearleft clearright clearleft-mobile clearright-mobile">
			        <img src='<?php echo Yii::$app->params['imgixUrl'] ?>promo/endsale/2018/Category-Page-<?php echo $type_text; ?>-Desktop.jpg' class="img-responsive bradius5">
			    </div>
			    <div class="hidden-lg hidden-md hidden-sm col-xs-12 clearleft clearright clearleft-mobile clearright-mobile">
			        <img src='<?php echo Yii::$app->params['imgixUrl'] ?>promo/endsale/2018/Category-Header-<?php echo $type_text; ?>-Mobile.jpg' class="img-responsive bradius5">
			    </div>
			    <div class="col-lg-12 col-md-12 col-sm-12 hidden-xs clearleft clearright clearleft-mobile clearright-mobile ptop10">
			        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearleft-mobile pright5p">
			            <a href="<?php echo \yii\helpers\Url::base(); ?>/endyear-sale?type=<?php echo $type_button == 116 ? 115 : 116; ?>">
			                <img src='<?php echo Yii::$app->params['imgixUrl'] ?>promo/endsale/2018/Tumbnail-<?php echo $type_text == 'Aktif' ? 'Casual':'Aktif'; ?>-Desktop.jpg' class="img-responsive bradius5">
			            </a>
			            
			        </div>
			        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 pright5p pleft5p">
			            <a href="<?php echo \yii\helpers\Url::base(); ?>/endyear-sale?type=<?php echo $type_button == 117 ? 115 : 117; ?>">
			                <img src='<?php echo Yii::$app->params['imgixUrl'] ?>promo/endsale/2018/Tumbnail-<?php echo $type_text == 'Aksesoris' ? 'Casual':'Aksesoris'; ?>-Desktop.jpg' class="img-responsive bradius5">
			            </a>
			            
			        </div>
			        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearright clearright-mobile pleft5p">
			            <a href="<?php echo \yii\helpers\Url::base(); ?>/endyear-sale?type=<?php echo $type_button == 12 ? 115 : 12; ?>">
			                <img src='<?php echo Yii::$app->params['imgixUrl'] ?>promo/endsale/2018/Tumbnail-<?php echo $type_text == 'Klasik' ? 'Casual':'Klasik'; ?>-Desktop.jpg' class="img-responsive bradius5">
			            </a>
			    ...
			    <div class="hidden-sm col-xs-12 hidden-lg hidden-md clearleft clearright clearleft-mobile clearright-mobile ptop10">
			        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 clearleft clearleft-mobile pright5p">
			            <a href="<?php echo \yii\helpers\Url::base(); ?>/endyear-sale?type=<?php echo $type_button == 116 ? 115 : 116; ?>">
			                <img src='<?php echo Yii::$app->params['imgixUrl'] ?>promo/endsale/2018/Category-Thumbnail-<?php echo $type_text == 'Aktif' ? 'Casual':'Aktif'; ?>-Mobile.jpg' class="img-responsive bradius5">
			            </a>
			            
			        </div>
			        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 pright5p pleft5p">
			            <a href="<?php echo \yii\helpers\Url::base(); ?>/endyear-sale?type=<?php echo $type_button == 117 ? 115 : 117; ?>">
			                <img src='<?php echo Yii::$app->params['imgixUrl'] ?>promo/endsale/2018/Category-Thumbnail-<?php echo $type_text == 'Aksesoris' ? 'Casual':'Aksesoris'; ?>-Mobile.jpg' class="img-responsive bradius5">
			            </a>
			            
			        </div>
			        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 clearright clearright-mobile pleft5p">
			            <a href="<?php echo \yii\helpers\Url::base(); ?>/endyear-sale?type=<?php echo $type_button == 12 ? 115 : 12; ?>">
			                <img src='<?php echo Yii::$app->params['imgixUrl'] ?>promo/endsale/2018/Category-Thumbnail-<?php echo $type_text == 'Klasik' ? 'Casual':'Klasik'; ?>-Mobile.jpg' class="img-responsive bradius5">
			            </a>
...
// 			}
            ...
            <?php //if($count > 4) {  ?>
            <section id="all-product-footer" style="padding-bottom: 100px;">
