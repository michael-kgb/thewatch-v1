    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
                <img src="https://thewatch.co/img/promo/valentine/valentine-bundle-detail.jpg" class="img-responsive">
            </div>
            <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                ...
                <div class="brand-name-full" style="font-family: gotham-light;">
                    The Watch Co. Valentine's Bundle Promo!
                </div>
                <div class="brand-description">
                    Nikmati diskon 14% off untuk setiap pembelian 2 jam tangan atau lebih khusus untuk Braun, Aark Collective, Autodromo, Daniel Wellington, Greyhours, Hypergrand, Komono, Mockberg, Nocs Atalier, Squarestreet, TID Watches, dan William L. 1985.
                                        <br><br>
      ...
      <!--                  </div>-->
        ...
        <div class="hidden-lg col-md-6 col-sm-6 hidden-xs breadcrumb-page">
            ...
            if($current_date >= '2017-11-06 00:00:00' && $current_date <= '2018-02-14 23:59:59'){
