    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
                <img src="https://thewatch.co/img/promo/weeksale/forthefans-detail.jpg" class="img-responsive">
            </div>
            <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                ...
                <div class="brand-name-full" style="font-family: gotham-light;">
                    The Watch Co. For The Fans!
                </div>
                <div class="brand-description">
                    <!--Saatnya dapatkan jam tangan idamanmu dengan diskon 10% di Deal of The Week. <br> Promo ini berlaku untuk semua produk jam tangan pilihan dengan harga normal yang tersedia di website The Watch Co ini. <br><br>-->
                    <!--Promo berlaku dari tanggal <strong>30 Januari - 6 Februari 2018</strong>. -->
                    <!--<br><br>-->
                    
                    <!--Untuk menikmati diskon 10% semua produk, gunakan kode voucher: "<strong>ONEWEEK</strong>" saat check out.-->
                    <!--                    <br><br>-->
      ...
      <!--                  </div>-->
        ...
        <div class="hidden-lg col-md-6 col-sm-6 hidden-xs breadcrumb-page">
            ...
            if($current_date >= '2017-11-06 00:00:00' && $current_date <= '2018-02-28 23:59:59'){
