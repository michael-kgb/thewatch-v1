    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
                <img src="https://thewatch.co/img/promo/ob-thehackney/hackney-detail-maret.jpg" class="img-responsive">
            </div>
            <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                ...
                <div class="brand-name-full" style="font-family: gotham-light;">
                    The Hackney Sweet Deal!
                </div>
                <div class="brand-description">
                    Take a look at our Olivia Burton The Hackney Series collection here or visit our offline stores.
      ...
      <!--                  </div>-->
        ...
        <div class="hidden-lg col-md-6 col-sm-6 hidden-xs breadcrumb-page">
            ...
            if($current_date >= '2017-11-06 00:00:00' && $current_date <= '2018-03-8 23:59:59'){
       ...
       <div class="col-lg-10 col-md-10 product-box space-cont-product">
        ...
        <?php if ($i == 5 || $i == 9 ||
                ...
                <div class="hidden-sm col-lg-12 col-md-12 cont product-box clearleft clearright clearleft-mobile clearright-mobile">
                    <div class="row">
        <?php } ?>
                    <?php if($product->product_id == 1467){ ?>
                    <div class="hidden-sm col-lg-3 col-md-3 space-product col-xs-6 pright75 mbottom-3-mobile">
                        
                                                    
                            
                        <a class="productClick" href="/product/OB16AM85">
                                                        <div style="position:relative;">
                                                                    <img src="/img/event/bee_mine.png" style="position: absolute;top:10px;width: 100px;right: 12px;">
                                                                  <div class="tag">
                                                                    </div>
                                                                                                                                        <img alt="Olivia Burton Animal Motif Moulded Bee Blush Dial Blush &amp; Rose Gold - OB16AM85" src="https://d3vq5glb73pll6.cloudfront.net/img/product/2983/2983.jpg" id="out-of-stock-1108" class="img-responsive ">
                                                                                            </div>
                            <input type="hidden" name="productId" value="1108">
                            <input type="hidden" name="productName" value="Animal Motif Moulded Bee Blush Dial Blush &amp; Rose Gold - OB16AM85">
                            <input type="hidden" name="brandName" value="Olivia Burton">
                            <input type="hidden" name="opt_list" value="Promo - ">
                            <input type="hidden" name="productCategory" value="watches">
                            <input type="hidden" name="productPosition" value="1">
                            <div class="col-lg-12 col-md-12 col-sm-12 product brand-title">OLIVIA BURTON</div>
                            <div class="col-lg-12 col-md-12 col-sm-12 product product-name"><span class="lspace0-5">Animal Motif Moulded Bee Blush Dial Blush &amp; Rose Gold - OB16AM85</span></div>
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 product-detail product-price discountview">
                                                                                IDR 2.450.000                                        <input type="hidden" class="price" name="price" value="2450000">
                                        
                                        <input type="hidden" class="weight" name="weight" value="500">
                                    </div>
                                								<input type="hidden" name="productPrice" value="2450000">
                            <div class="col-lg-12 col-md-12 col-sm-12 product product-price"><span class="lspace2">IDR </span></div> 
                    ...
                    <?php } ?>
                    <?php if($product->product_id == 1108){ ?>
                    <div class="hidden-sm col-lg-3 col-md-3 space-product col-xs-6 pright75 mbottom-3-mobile">
                        
                                                    
                            
                        <a class="productClick" href="/product/OB16AM90">
                                                        <div style="position:relative;">
                                                                    <img src="/img/event/bee_mine.png" style="position: absolute;top:10px;width: 100px;right: 12px;">
                                                                  <div class="tag">
                                                                    </div>
                                                                                                                                        <img alt="Olivia Burton Square Dial 3D Bee Gold Mesh - OB16AM90" src="https://d3vq5glb73pll6.cloudfront.net/img/product/3955/3955.jpg" id="out-of-stock-1467" class="img-responsive ">
                                                                                            </div>
                            <input type="hidden" name="productId" value="1467">
                            <input type="hidden" name="productName" value="Square Dial 3D Bee Gold Mesh - OB16AM90">
                            <input type="hidden" name="brandName" value="Olivia Burton">
                            <input type="hidden" name="opt_list" value="Promo - ">
                            <input type="hidden" name="productCategory" value="watches">
                            <input type="hidden" name="productPosition" value="5">
                            <div class="col-lg-12 col-md-12 col-sm-12 product brand-title">OLIVIA BURTON</div>
                            <div class="col-lg-12 col-md-12 col-sm-12 product product-name"><span class="lspace0-5">Square Dial 3D Bee Gold Mesh - OB16AM90</span></div>
                                                                
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 product-detail product-price discountview">
                                                                                        IDR 3.000.000                                            <input type="hidden" class="price" name="price" value="3000000">
                                                                                        <input type="hidden" class="weight" name="weight" value="500">
                                        </div>
                                                                    								<input type="hidden" name="productPrice" value="3000000">
                            <div class="col-lg-12 col-md-12 col-sm-12 product product-price"><span class="lspace2">IDR </span></div> 
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 product-detail product-installment" style="text-align: left;">
                                                                                IDR 250.000 / bulan
                    ...
                    <?php } ?>
                    <?php if($product->product_id != 1467 && $product->product_id != 1108){ ?>
                    <div class="hidden-sm col-lg-3 col-md-3 space-product col-xs-6 <?php echo $i % 2 == 0 ? 'pleft75' : 'pright75'; ?> mbottom-3-mobile">
                        ...
                        <a class="productClick" <?php echo $stock->quantity == 0 ? 'id="out-of-stock" data-id="'.$product->product_id.'"' : ''; ?> href="<?php echo \yii\helpers\Url::base(); ?>/product/<?php echo $product->productDetail->link_rewrite; ?>">
                            ...
                            <?php } ?>
                            <div style="position:relative;">
                                <?php if(in_array($product->product_id, array(1467,1635,1991,1108,1115,1639,1640,1698,1701,1997,1998,1417,1423,1579,1580,1706,1714,1768,1779,1652,1999,2000,2002,2003,2020,2021))){ ?>
                                    <img src="<?php echo \yii\helpers\Url::base(); ?>/img/event/bee_mine.png" style="position: absolute;top:10px;width: 100px;right: 12px;">
                                  <?php } ?>
                                <div class="tag">
                                    <?php
