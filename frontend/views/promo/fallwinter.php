    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
				...
				<img src="https://thewatch.co/img/promo/fallwinter/detail banner.jpg" class="img-responsive">
            ...
            if($current_date >= '2019-10-21 00:00:00' && $current_date <= '2019-10-25 23:59:59'){
                ?>
					Let’s be prepared to keep you in style through the season    				
                        <br>
