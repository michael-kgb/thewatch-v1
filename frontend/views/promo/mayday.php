    ...
    if (distance < 0) {
        ...
        ?>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
                <img src="https://thewatch.co/img/promo/weeksale/weeksale-detail-maret.jpg" class="img-responsive">
            </div>
            <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                ...
                <div class="brand-name-full" style="font-family: gotham-light;">
                    The Watch Co. Weekend Sale!
                </div>
                <div class="brand-description">
                    <?php
            $current_date = date('Y-m-d H:i:s');
            if($current_date >= '2018-03-30 00:00:01' && $current_date <= '2018-03-31 23:59:59'){
                ?>
                    Diskon 20% untuk semua produk KOMONO!   <br>
Promo berlaku hanya 30 dan 31 Maret 2018. Beli Sekarang!
