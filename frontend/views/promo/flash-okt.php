        ...
        ?>
			...
			<section style="padding-top:20px;padding-bottom:20px;">
				<div class="col-lg-12 col-md-12 hidden-xs col-sm-12 clearleft clearright" style="padding-bottom:20px;">
                    ...
                    <div class="col-lg-6 clearleft pright75"><a href="<?php echo $link_btn3; ?>" class="flash-button <?php echo $button3 == 1 ? 'active':'' ?>"><?php echo $date_today_3; ?></a></div>
				</div>
				<div class="swiper-flash-menu-mobile col-xs-12 hidden-lg hidden-md hidden-sm" style="padding-bottom:20px;overflow-y:hidden;">
					<div class="swiper-wrapper">
                        ...
                        <div class="col-lg-6 clearleft pright75"><a href="<?php echo $link_btn3; ?>" class="flash-button <?php echo $button3 == 1 ? 'active':'' ?> text-small"><?php echo $date_today_3; ?></a></div>
					</div>
				</div>
			</section>
