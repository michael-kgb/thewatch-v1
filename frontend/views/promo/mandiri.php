    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
                <img src="https://thewatch.co/img/promo/mandiri/detail-banner-sale-070818.jpg" class="img-responsive">
            </div>
            <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                ...
                <div class="brand-name-full" style="font-family: gotham-light;">
                    Promo Kartu Kredit Bank Mandiri
                </div>
                <div class="brand-description">
                    <?php
            $current_date = date('Y-m-d H:i:s');
            if($current_date >= '2018-03-30 00:00:01' && $current_date <= '2018-08-31 23:59:59'){
                ?>
                    Nikmati extra diskon sampai 10% bagi pengguna Bank Mandiri.   <br>
                    Syarat dan ketentuan: <br>
                    <ol>
                        <li>Promo ini hanya berlaku untuk pengguna kartu kredit Bank Mandiri</li>
                        <li>Bagi pengguna kartu kredit Bank Mandiri, nikmati cicilan 0% dengan tenor 3, 6, dan 12 bulan untuk pembayaran minimal Rp. 500.000,-</li>
                        <li>Extra diskon 5% berlaku untuk pembelian produk yang sedang diskon, dan extra diskon 10% berlaku untuk pembelian produk dengan harga normal</li>
                        <li>Untuk menikmati extra diskon, hanya berlaku pembelian produk di halaman ini</li>
                        <li>Promo berlaku tanggal 1 – 31 Agustus 2018</li>
                    </ol>
      ...
      <!--                  </div>-->
            ...
            <?php
            $current_date = date('Y-m-d H:i:s');
            if($current_date >= '2018-08-01 00:00:01' && $current_date <= '2018-08-31 23:59:59'){
