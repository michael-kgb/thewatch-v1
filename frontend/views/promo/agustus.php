...
<section class="ptop1" style="padding-bottom:5px;">
    <div class="container">
        <div class="row">
            <!--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearleft clearright salebrandbannerview">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ptop2 remove-padding clearleft clearright ">
                    <a href="<?php echo \yii\helpers\Url::base(); ?>/promo-merdeka-17-agustus">
                        <img src='<?php echo \yii\helpers\Url::base(); ?>/img/promo/merdeka/merdeka++_home_banner_d.jpg' class="img-responsive">
                    </a>
                </div>
            </div>-->
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
                    ...
                    <img src="<?php echo \yii\helpers\Url::base(); ?>/img/promo/merdeka/merdeka_sale_detail_2.jpg" class="img-responsive">
              
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8 clearright">
      ...
      <!--                  </div>-->
			...
			<?php
            $current_date = date('Y-m-d H:i:s');
            if($current_date >= '2019-08-08 00:00:00' && $current_date <= '2019-08-31 00:00:00'){
