    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
                <img src="https://thewatch.co/img/promo/taketimetimex/page-banner-detail-030818.jpg" class="img-responsive">
            </div>
            <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite">
                ...
                <div class="brand-name-full" style="font-family: gotham-light;">
                    Promo jam tangan Timex sampai dengan 40%.
                </div>
                <div class="brand-description">
                    Promo jam tangan Timex sampai dengan 40%.<br>
                    Berlaku hingga 31 Agustus 2018. Stock terbatas!


                                        <br><br>
                                         Ayo dapatkan jam tangan Timex favoritmu sekarang!
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearright clearleft mbottom3">
                <img src="<?php echo Yii::$app->params['imgixUrl'] ?>promo/marchpromo/march_promo_desktop.jpg?auto=compress%2Cformat&fm=pjpg" class="img-responsive">
            </div>
            ...
            if($current_date >= '2017-11-06 00:00:00' && $current_date <= '2019-03-31 23:59:59'){
