    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
                <img src="https://thewatch.co/img/promo/furtherreduction/furtherdetail.jpg" class="img-responsive">
            </div>
            <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite">
                ...
                <div class="brand-name-full" style="font-family: gotham-light;">
                    The Watch Co. Further Reduction Sale!
                </div>
                <div class="brand-description">
                    Discount besar The Watch Co. masih berlanjut di Further Reduction Sale.
                    Dapatkan discount sampai dengan 50% untuk brand jam tangan favoritemu.

                                        <br><br>
                                       																		<label style="font-size: 10px;">*Products that are selected here are within 85% - 98% condition</label>
...
Dapatkan discount sampai dengan 50% untuk brand jam tangan favoritemu.
      ...
      <!--                  </div>-->
        ...
        <div class="hidden-lg col-md-6 col-sm-6 hidden-xs breadcrumb-page">
            ...
            if($current_date >= '2017-11-06 00:00:00' && $current_date <= '2018-01-31 23:59:59'){
