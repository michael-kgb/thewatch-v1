...
var dataLayer = [],
    ...
    items.push({
        ...
        "position": <?php echo $i; ?>,
        "list": "Landing Page Promo Vospay"
    })
    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
				...
				<img src="https://thewatch.co/img/promo/vospay/oct-2019/detail-banner.jpg" class="img-responsive">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                ...
                <div class="brand-name-full" style="font-family: gotham-light;">
                    Promo Diskon Vospay Oktober 2019
            ...
            if($current_date >= '2019-10-01 00:00:00' && $current_date <= '2019-11-01 00:00:00'){
                ?>
                    Bagi pengguna Vospay, saatnya nikmati promo spesial bulan Oktober 2019 dengan dikon 30% setiap pembelian semua produk di The Watch Co. 
    				
                        <br>
                    Syarat dan ketentuan: <br>
                    <ol>
                        <li>Promo dimulai dari periode 1 hingga 31 Oktober 2019</li>
                        <li>Promo diskon Vospay 30% dapat dinikmati setiap pembelian produk The Watch Co. online dengan minimum Rp. 1.000.000,- dan maksimum potongan sebesar Rp. 300.000,-</li>
                        <li>Khusus promo diskon ini hanya berlaku untuk metode pembayaran vospay </li>
