    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
				...
				<img src="https://thewatch.co/img/promo/flash/12_12_19/12.12++_Detail Banner.jpg" class="img-responsive">
				
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                            
                <h1 class="brand-name-full" style="font-family: gotham-light;margin-top:0;">
                   Waktunya Flash Sale 12.12
            ...
            if($current_date >= '2019-12-01 00:00:00' && $current_date <= '2020-12-31 23:59:59'){ 
                ?>
                        Syarat dan ketentuan:<br>
                        1.	Promo dimulai dari periode 10 – 12 Desember 2019, pukul 12.12 – 16.00 WIB<br>
                        2.	Untuk menikmati promo Waktunya Flash Sale 12.12 hanya berlaku di halaman ini<br>
                        3.	Gunakan kode voucher: TWCEXTRA12 untuk mendapatkan diskon tambahan 12% (khusus untuk brand Timex, Olivia Burton, CHPO, BEU Watches, dan NAM Watch)<br>
                        4.	Cicilan 0% kartu kredit berlaku untuk minimum pembelian Rp. 500.000,- dengan tenor 3, 6, dan 12 bulan<br>
                        5.	Gratis ongkir ke seluruh Indonesia bisa didapatkan dengan minimum pembelian Rp. 1.000.000,- setelah diskon<br>
                        ...
                        9.	Dengan mengikuti promo ini, pengguna dianggap mengerti dan menyetujui semua syarat dan ketentuan yang berlaku<br>
      ...
      <!--                  </div>-->
			...
			<?php
            $current_date = date('Y-m-d H:i:s');
            if($current_date >= '2019-11-01 00:00:00' && $current_date <= '2020-12-31 23:59:59'){
                                    ...
                                    if (!empty($product->specificPrice)) {
                                        if ($product->specificPrice->from <= $now && $product->specificPrice->to > $now) {
                                            ...
                                            <div class='pull-right'>
                                                <div class='<?php echo $product->specificPrice->label_type === "custom_value" ? "rounded" : "circle"; ?> flash'>
        ...
        <div class="container clearleft">
                    ...
                    <div class="hidden-lg hidden-md hidden-sm" id="readmore" style="padding-top: 11px; padding-bottom: 1px; text-align: justify;">
                        <p class="show-read-more">
                            ...
                            <p class="seodesc">Hari belanja online nasional atau sering disebut harbolnas merupakan acara yang setiap tahun diadakan oleh pelaku industri online guna mendukung pertumbuhan pasar Indonesia secara digital. Acara yang diadakan...<br><br><a>(Baca Selengkapnya)</a>                        </p>
                    </div>
                    ...
                    <div class="hidden-lg hidden-md hidden-sm" id="right" style="padding-top: 11px; padding-bottom: 1px; text-align: justify; display: none;">
                        <p class="show-read-more">
                            </p><p class="seodesc"><strong>Beli Jam Tangan Original Di Harbolnas</strong></p>
