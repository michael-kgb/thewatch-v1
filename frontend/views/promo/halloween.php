    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
				...
				<img src="https://thewatch.co/img/promo/halloween/2019/Halloween_Detail Banner.jpg" class="img-responsive">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                ...
                <div class="brand-name-full" style="font-family: gotham-light;">
                    <h1 class="fsize-13 gotham-medium mtop0">Happy Halloween!</h1>
                </div>
                <div class="brand-description">
                    <?php
            
            if($current_date >= '2019-10-03 00:00:01' && $current_date <= '2019-10-31 23:59:59'){
                ?>
                    Don't trick but treat yourself with our special products selection!
                        <br>
