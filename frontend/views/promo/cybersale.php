    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
                ...
                ?>
				<img src="https://thewatch.co/img/promo/tujuhbelas/page-banner-detail-170818.jpg" class="img-responsive">
				<?php }elseif($current_date >= '2018-08-18 00:00:01'){ ?>
				<img src="https://thewatch.co/img/promo/tujuhbelas/Sale-Banner-Detail.jpg" class="img-responsive">
				<?php }else{ ?>
				<img src="https://thewatch.co/img/promo/tujuhbelas/page-banner-detail-010818.jpg" class="img-responsive">
				<?php } ?>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite" style="padding-top:0px;">
                ...
                <div class="brand-name-full" style="font-family: gotham-light;">
                    <h1 class="fsize-13 gotham-medium mtop0">Promo 10 – 10 – 2018, Cyber Sale</h1>
                </div>
                <div class="brand-description">
                    <?php
            
            if($current_date >= '2018-10-03 00:00:01' && $current_date <= '2018-10-13 23:59:59'){
                ?>
  
        				The Watch Co. Cyber Sale 10 – 10 hadir di tahun 2018 ini dengan memberikan promo menarik. Nikmati diskon dengan harga special hanya untuk pembelian produk pilihan yang tersedia dibawah ini.
    				
                        <br>
                    Syarat dan ketentuan: <br>
                    <ol>
                        <li>Dapatkan harga spesial untuk produk yang tersedia di halaman ini</li>
                        ...
                        <li>Diskon dapat digunakan otomatis, tanpa memasukan kode voucher</li>
                        <li>Promo Cyber Sale 10 – 10 – 2018 ini hanya bisa dinikmati tanggal 9 – 11 Oktober 2018</li>
                    </ol>
      ...
      <!--                  </div>-->
            ...
            if($current_date >= '2018-10-09 00:00:00' && $current_date <= '2018-10-11 23:59:59'){
                        ...
                        <a class="productClick" <?php echo $stock->quantity == 0 ? 'id="out-of-stock" data-id="'.$product->product_id.'"' : ''; ?> href="<?php echo \yii\helpers\Url::base(); ?>/product/<?php echo $product->productDetail->link_rewrite; ?>">
							...
							<div style="position:relative;">
								<div class="tag" style="right: 0; left: 15px; top: 15px;">
									<img src="<?php echo \yii\helpers\Url::base(); ?>/img/promo/tujuhbelas/cyber-sale.png">
								</div>
    ...
    margin-top: -70px;">  
        <div class="container clearleft">
                    <div class="col-lg-6 col-md-6 col-sm-6 hidden-xs clearleft seo-description-left">
                            ...
                            <h2 class="seodesc fsize-11"><strong>The Watch Co. Cyber&nbsp;</strong></h2>

                            <p class="seodesc">Di era yang serba digital sekarang ini, kebanyakan orang menginginkan gaya hidup yang cepat dan praktis. Berkat kemajuan teknologi, semua itu bisa diwujudkan. Kita bisa lihat bahwa saat ini pengguna smartphone sudah semakin banyak dan terus bertambah. Hal tersebut bisa dijadikan sebagai peluang besar untuk mendapatkan informasi secara cepat dan mudah tanpa dihalangi oleh batasan. Semua orang bisa mengkases apapun hanya di depan layer dan genggaman tangan saja. Dari fenomena tersebut, The Watch Co. menghadirkan konsep yang bertema “Cyber”.</p>
                            
                           
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 hidden-xs seo-description-right">
                            
                            <h2 class="seodesc fsize-11"><strong>Cyber Sale: Promo 10-10-2018</strong></h2>

                            <p class="seodesc">Bagi yang suka fashion, saatnya lengkapi koleksimu dengan belanja produk fashion seperti jam tangan, tas, dan aksesoris lainnya di The Watch Co. Karena tanggal 10 Oktober 2018 mengadakan promo 10-10 dengan harga special. Selain mendapatkan harga special, produk yang kamu dapatkan benar-benar original, bergaransi resmi, cicilan 0% bagi pengguna kartu kredit, dan gratis ongkir.Jjika kamu ingin cicilan tapi tidak punya kartu kredit masih bisa, gunakan fitur akulaku, kredivo, dan vospay. Yuk manfaatkan Cyber Sale 10-10 untuk mendapatkan harga spesialnya sekarang!</p>
                    ...
                    <div class="hidden-lg hidden-md hidden-sm" id="readmore" style="padding-top: 11px; padding-bottom: 1px; text-align: justify;">
                        <p class="show-read-more">
                            ...
                            <p class="seodesc">Di era yang serba digital sekarang ini, kebanyakan orang menginginkan gaya hidup yang cepat dan praktis. Berkat kemajuan teknologi, semua itu bisa diwujudkan. Kita bisa lihat bahwa saat ini pengguna smartphone sudah semakin banyak dan terus bertambah...<br><br><a>(Baca Selengkapnya)</a>                        </p>
                    </div>
