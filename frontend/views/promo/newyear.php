    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
				...
				<img src="https://thewatch.co/img/promo/newyear/2020/New Year Deals_Detail Banner.jpg" class="img-responsive">
            ...
            if($current_date >= '2020-01-01 00:00:00' && $current_date <= '2020-01-31 23:59:59'){ 
                ?>
Selamat Tahun Baru 2020. Ayo sambut tahun baru ini dengan semangat yang baru. Agar kamu lebih semangat, nikmati diskon hingga 70% untuk produk favoritmu.<br><br>
Syarat dan ketentuan:<br>
1.	Promo berlaku hingga 31 januari 2020<br>
