    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearleft clearright mbottom3">
                <img src="https://thewatch.co/img/promo/limasale/limasale-small.jpg" class="img-responsive">
            </div>
            <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs clearright pleft-5-dwpetite">
                ...
                <div class="brand-name-full" style="font-family: gotham-light;">
                    The Watch Co. LIMA Watch Sale!
                </div>
                <div class="brand-description">
                    Nikmati diskon 25% untuk produk unggulan dari LIMA Watch.
                                        <br><br>
                                        Promo ini berlaku hingga 31 Desember 2017.
Stock terbatas!
																				<br><br>																				
...
Stock terbatas!
      ...
      <!--                  </div>-->
        ...
        <div class="hidden-lg col-md-6 col-sm-6 hidden-xs breadcrumb-page">
            ...
            if($current_date >= '2017-11-06 00:00:00' && $current_date <= '2017-12-31 23:59:59'){
