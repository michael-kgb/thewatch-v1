				...
				<div class="thumbnail-flash-sale" style="width:100%;">
					...
					<!--
						<picture>
							...
							<img srcset="<?php echo Yii::$app->params['imgixUrl'].$banner_desktop; ?>" alt="Flash Sale">
						</picture>
					-->
						<img sizes="(min-width: 1200px) 80vw, 100vw" src="<?php echo Yii::$app->params['imgixUrl'].$banner_desktop; ?>" data-was-processed="true" class="img-responsive hidden-xs" style="display: block;margin: auto; width:100%;">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 clearleft clearright line-height40 talign-right">
                                        ...
                                        <div class="clearleft clearright hidden-xs hidden-sm hidden-lg-4" style="display: inline;">
                                            ...
                                            <div class="hidden-xs sorting-box talign-left" id="box-sorting">
                                                <a class="sorting-list top" href="<?php echo \yii\helpers\Url::base() . '/' . $page_url . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=price-low-to-high'; ?>">Price Low to High</a>
                                                <a class="sorting-list" id="sorting-none" href="<?php echo \yii\helpers\Url::base() . '/' . $page_url . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=price-high-to-low'; ?>">Price High to Low</a>
                                                <a class="sorting-list bottom" href="<?php echo \yii\helpers\Url::base() . '/' . $page_url . '?' . $params . '&page='.$current.'&limit='.$limit.'&sortby=none'; ?>">Brands Name</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xs-12 col-sm-12">
                            ...
                            ?>
                                ...
                                <?php if($current <= 1){
                                    ...
                                    <a class="blue-round default top-paging" style="padding:2px !important;" href="<?php echo \yii\helpers\Url::base() . '/' . $page_url . '?' . $params .'&page='.$prev.'&limit=20'; ?>&sortby=<?php echo $sortby;?>">
                                        <span class="col-sm-4 col-xs-4 clearright-mobile talign-left" style="padding-left: 5px;display: grid;"><i class="left-white-sprite"></i></span>
                                        <span class="col-sm-8 col-xs-8 clearleft-mobile clearright-mobile fsize-12">Prev</span>
                                    </a>
                                ...
                                <?php if($current == $page_item){
                                    ...
                                    <a class="blue-round default top-paging" style="padding:2px !important;" href="<?php echo \yii\helpers\Url::base() . '/' . $page_url . '?' . $params .'&page='.$next.'&limit=20'; ?>&sortby=<?php echo $sortby;?>">
                                        <span class="col-sm-10 col-xs-10 clearleft-mobile clearright-mobile fsize-12" style="padding-left: 4px;">Next</span>
                                        <span class="col-sm-2 col-xs-2 clearleft-mobile talign-right" style="padding-right: 5px;display: grid;"><i class="right-white-sprite"></i></span>
                                    </a>
                            ...
                            ?>
                                ...
                                <?php if($current <= 1){
                                    ...
                                    <a class="blue-round default top-paging" style="padding:2px !important;padding-top:3px !important;" href="<?php echo \yii\helpers\Url::base() . '/' . $page_url . '?' . $params .'&page='.$prev.'&limit=20'; ?>&sortby=<?php echo $sortby;?>">
                                        <span class="col-sm-4 col-xs-4 clearright talign-left pleft5p"><i class="left-white-sprite"></i></span>
                                        <span class="col-sm-8 col-xs-8 clearleft clearright fsize-12">Prev</span>
                                ...
                                <?php if($current == $page_item){
                                    ...
                                    <a class="blue-round default top-paging" style="padding:2px !important;padding-top:3px !important;" href="<?php echo \yii\helpers\Url::base() . '/' . $page_url . '?' . $params .'&page='.$next.'&limit=20'; ?>&sortby=<?php echo $sortby;?>">
                                        <span class="col-sm-8 col-xs-8 clearleft clearright fsize-12">Next</span>
                                        <span class="col-sm-4 col-xs-4 clearleft talign-right pright5p"><i class="right-white-sprite"></i></span>
                                    </a>
                            ...
                            <div class="hidden-lg hidden-md col-sm-7 col-xs-7 remove-padding clearright" style="float:right;text-align:right;">
                                <span class="fcolorblue">View : </span>
                                        <a <?php if($limit == 20){ echo ' class="circle-fill-sprites25 fcolorfff talign-center fsize-12"';}else{ echo 'class="circle-sprites25 fcolorblue talign-center fsize-12"';}?> href="<?php echo \yii\helpers\Url::base() . '/' . $page_url . '?' . $params . '&page=1&limit=20'; ?>&sortby=<?php echo $sortby;?>"><span class="lheight-paging">20</span></a>

                                        <a <?php if($limit == 40){ echo ' class="circle-fill-sprites25 fcolorfff talign-center fsize-12"';}else{ echo 'class="circle-sprites25 fcolorblue talign-center fsize-12"';}?> href="<?php echo \yii\helpers\Url::base() . '/' . $page_url . '?' . $params . '&page=1&limit=40'; ?>&sortby=<?php echo $sortby;?>"><span class="lheight-paging">40</span></a>

                                        <a <?php if($limit == 60){ echo ' class="circle-fill-sprites25 fcolorfff talign-center fsize-12"';}else{ echo 'class="circle-sprites25 fcolorblue talign-center fsize-12"';}?> href="<?php echo \yii\helpers\Url::base() . '/' . $page_url . '?' . $params . '&page=1&limit=60'; ?>&sortby=<?php echo $sortby;?>"><span class="lheight-paging">60</span></a>

                                        <a <?php if($limit == 100){ echo ' class="circle-fill-sprites25 fcolorfff talign-center fsize-12"';}else{ echo 'class="circle-sprites25 fcolorblue talign-center fsize-12"';}?> href="<?php echo \yii\helpers\Url::base() . '/' . $page_url . '?' . $params . '&page=1&limit=100'; ?>&sortby=<?php echo $sortby;?>"><span class="lheight-paging">100</span></a> 
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <div class="modal-body title-warranty" style="padding-left:0;padding-right:0;margin-top:10px;padding-top:5px;height:240px;">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearleft clearright clearleft-mobile clearright-mobile talign-left gotham-light">
			...
			<?php
			  ...
			  }elseif( ($current_date > '2019-01-31') && ($current_date <= '2019-02-02 21:00:00') ){
				echo 'The Watch Co. Festival Extra';
		  	  }else{
			...
			<?php
			  if( ($current_date < '2019-01-29') ){
				  ...
				  echo '<ol>';
					  echo '<li>Promo dimulai dari periode 01 hingga 02 Februari 2019, pukul 17.00 – 21.00 WIB</li>';
					  echo '<li>Untuk menikmati promo The Watch Co. Festival Extra hanya berlaku di halaman flash sale</li>';
					  echo '<li>Khusus promo flash sale ini hanya berlaku untuk metode pembayaran Virtual Account, kartu kredit (full payment dan cicilan), akulaku, vospay, kredivo, dan go-pay</li>';
					  echo '<li>Cicilan 0% kartu kredit berlaku untuk minimum pembelian Rp. 500.000,- dengan tenor 3, 6, dan 12 bulan</li>';
					  echo '<li>Gratis ongkir ke seluruh Indonesia bisa didapatkan dengan minimum pembelian Rp. 1.000.000,-</li>';
					  echo '<li>Setiap pembelian produk dikenakan biaya asuransi pengiriman sebagai tambahan agar produk yang anda pesan lebih aman sampai tujuan</li>';
