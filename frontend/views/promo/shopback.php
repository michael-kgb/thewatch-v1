...
<section class="ptop1" style="padding-bottom:5px;">
    <div class="container">
        <div class="row">
            ...
            if($current_date >= '2018-03-30 00:00:01' && $current_date <= '2018-09-07 23:59:59'){
                ?>
                    Promo Shopback The Watch Co.
                    ...
                    <ol>
                        <li>Potongan Rp 150,000,-</li>
                        <li>Potongan berlaku apabila menggunakan kode promo <span class="gotham-medium">SHOPFEST</span>.</li>
                        <li>Promo tidak bisa digabung dengan promo lain</li>
                        <li>Promo akan berlangsung dari tanggal 5 – 7 September 2018</li>
                    </ol>
      ...
      <!--                  </div>-->
			...
			<?php
            $current_date = date('Y-m-d H:i:s');
            if($current_date >= '2018-08-01 00:00:01' && $current_date <= '2018-09-07 23:59:59'){
