                ...
                if (count($productImages) > 0) { ?>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12 thumbnail-product clearleft " id="product-thumb">
                        <ul id="thumb-small">
                            ...
                            data-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/1.jpg" 
                            data-zoom-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/1.jpg" 
                            style="overflow: hidden; float: none; width: 50px; height: 69px;">
                                <a href="#" onclick="video_stop_product();" class="small-thumb active" id="0" 
                                data-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/1.jpg" 
                                data-zoom-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/1.jpg">
                                    <img alt="" 
                                    src="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/1.jpg" 
                                    class="img-responsive">
                                </a>
                            </li>
							 <li class="small-thumb" id="0" 
                            data-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/2.jpg" 
                            data-zoom-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/2.jpg" 
                            style="overflow: hidden; float: none; width: 50px; height: 69px;">
                                <a href="#" onclick="video_stop_product();" class="small-thumb active" id="0" 
                                data-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/2.jpg" 
                                data-zoom-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/2.jpg">
                                    <img alt="" 
                                    src="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/2.jpg" 
                                    class="img-responsive">
                                </a>
                            </li>
							<li class="small-thumb" id="0" 
                            data-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/3.jpg" 
                            data-zoom-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/3.jpg" 
                            style="overflow: hidden; float: none; width: 50px; height: 69px;">
                                <a href="#" onclick="video_stop_product();" class="small-thumb active" id="0" 
                                data-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/3.jpg" 
                                data-zoom-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/3.jpg">
                                    <img alt="" 
                                    src="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/3.jpg" 
                                    class="img-responsive">
                                </a>
                            </li>
                            <li class="small-thumb" id="0" 
                            data-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/4.jpg" 
                            data-zoom-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/4.jpg" 
                            style="overflow: hidden; float: none; width: 50px; height: 69px;">
                                <a href="#" onclick="video_stop_product();" class="small-thumb active" id="0" 
                                data-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/4.jpg" 
                                data-zoom-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/4.jpg">
                                    <img alt="" 
                                    src="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/4.jpg" 
                                    class="img-responsive">
                                </a>
                            </li>
							<li class="small-thumb" id="0" 
                            data-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/5.jpg" 
                            data-zoom-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/5.jpg" 
                            style="overflow: hidden; float: none; width: 50px; height: 69px;">
                                <a href="#" onclick="video_stop_product();" class="small-thumb active" id="0" 
                                data-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/5.jpg" 
                                data-zoom-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/5.jpg">
                                    <img alt="" 
                                    src="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/5.jpg" 
                                    class="img-responsive">
                                </a>
                            </li>
							<li class="small-thumb" id="0" 
                            data-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/6.jpg" 
                            data-zoom-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/6.jpg" 
                            style="overflow: hidden; float: none; width: 50px; height: 69px;">
                                <a href="#" onclick="video_stop_product();" class="small-thumb active" id="0" 
                                data-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/6.jpg" 
                                data-zoom-image="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/6.jpg">
                                    <img alt="" 
                                    src="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/6.jpg" 
                                    class="img-responsive">
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 clearleft-ipad clearright clearleft image-thumb" style="display: block;">
                        <img alt="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/1.jpg" 
                        id="product-img" 
                        src="<?php echo \yii\helpers\Url::base(); ?>/img/landing/qtimex/product/1.jpg" 
                ...
                <div class="tab-content">
                    ...
                    <div id="menu1" class="tab-pane tab-custom active">
                        <p>
                            ...
                            Domed Acrylic Crystal<br>
                            Rotating Top Ring<br>
                            Luminant Hands<br>
                            Caseback ‘True to the Past’ with Battery Hatch  <br>
                            Day/Date<br>
                        </p>
                    </div>
