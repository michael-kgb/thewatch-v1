									...
									<div class="col-sm-12">
										<table id="table-status">
											...
											foreach ($order_history as $row) {
												...
												?>
												<tr>
													<td width="15%"><?php echo $order_state_lang->name; ?></td>
                ...
                <div class="box-body">
                    <div class="col-sm-12">
						...
						<div class="col-sm-8"><div class="pull-left">
							<?php echo $model->customeraddress->firstname . ' ' . $model->customeraddress->lastname; ?><br/>
            ...
            <div  id="customer-address" class="box box-info" style="margin-top: 20px;">
                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-5 pull-right" style="border: 1px #cccccc solid;">
                        ...
                        <div class="col-sm-5"><div class="pull-right"><?php
                                echo ($model->apps_language_id == 2) ? "Rp. " : "$";
                                echo \common\components\Helpers::getPriceFormat($totalDiscount);
                                ?></div></div>
                        <br/>
                        ...
                        <div class="col-sm-5"><div class="pull-right"><?php if($model->total_special_promo != 0) { echo 'Rp. '.\common\components\Helpers::getPriceFormat($model->specialPromo->promo_amount); }else{ echo '-';} ?></div></div>
                        <br/>
