	...
	<div class="row">
		<div class="col-12">
			<div class="page-title-box">
				<h4 class="page-title float-left">Input New Orders</h4>
				...
				<div class="row">
					...
					<div class="col-12">
						<div class="mt-3 pull-left">
							<p class="m-b-10"><strong>Order Date: </strong> <input class="form-control" type="date" name="order_date" value="<?php echo date('Y-m-d'); ?>" /></p>
							...
							<p class="m-b-10"><strong>Order ID: </strong> <input required class="form-control" type="text" name="order_reference" placeholder="#12345" /></p>
						</div>
					</div><!-- end col -->
				</div>
				<!-- end row -->
				...
				<div class="row">
					...
					<div class="col-6">
						<div class="float-right">
							<p><b>Sub Total:</b> IDR <span id="subtotal-order">0</span></p>
							<h3>IDR <span id="grandtotal-order">0</span></h3>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
