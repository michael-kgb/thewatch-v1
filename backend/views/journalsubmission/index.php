...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#">Journal Submission</a></li>
    </ol>
</section>
                        ...
                        <table id="data-grid" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $row) {
                                    ...
                                    echo '</td>';
                                    echo '<td>';
                                    echo $row->journal_submission_name;
                                    echo '</td>';
                                    echo '<td>';
                                    echo $row->journal_submission_email;
                                    echo '</td>';
                                    echo '<td>';
                                    echo $row->journal_submission_phone;
                                    echo '</td>';
                                    echo '<td>';
                                    echo $row->journalCategory->journal_category_name;
                                    echo '</td>';
                                    echo '<td>';
                                    echo $row->journal_submission_material;
                                    echo '</td>';
                                    echo '<td>';
                                    
                                    echo '</td>';
                                    echo '<td>';
                                    echo '<div class="btn-group"><button type="button" class="btn btn-default" onclick="javascript:location.href=&#39;view/' . $row->journal_submission_id . '&#39;"><i class="fa fa-fw fa-eye"></i> View</button><button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>';

                                    if ($update_access == '1' || $delete_access == '1') {
                                        echo '<ul class="dropdown-menu" role="menu">';
                                        if ($update_access == '1') {
                                            echo '<li><a href="update/' . $row->journal_submission_id . '"><i class="fa fa-fw fa-pencil"></i> Update</a></li>';
                                        }

                                        if ($delete_access == '1') {
                                            echo '<li><a onclick="delete_journal('.$row->journal_submission_id.')"><i class="fa fa-fw fa-trash"></i> Delete</a></li>';
                                        }
