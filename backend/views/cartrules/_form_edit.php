                    ...
                    <div class="tab-pane active" id="information">
                        <div class="box-body">
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="cartrule[name]" id="inputEmail3" placeholder="Name" required="true" value="<?php echo $model->cartRuleLang->name; ?>">
                                </div>
                            </div>
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                <label for="inputEmail3" class="col-sm-2 control-label">Description</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" rows="5" name="cartrule[description]"><?php echo $model->description; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group margin" style="margin: 0px;">
                                        <input type="text" class="form-control" id="voucher-code" name="cartrule[vouchercode]" required="true" value="<?php echo $model->code; ?>">
                            ...
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" name="cartrule[partialuse]">
                                        <option value="1" <?php if($model->highlight == 1) echo 'selected'; ?>>Yes</option>
                                        <option value="0" <?php if($model->highlight == 0) echo 'selected'; ?>>No</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="cartrule[priority]" id="inputEmail3" value="<?php echo $model->priority; ?>">
                                </div>
                            </div>
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" name="cartrule[active]">
                                        ...
                                        <option value="0" <?php if($model->active == 0) echo 'selected'; ?>>Deactive</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="prices">
                        <div class="box-body">
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group margin" style="margin: 0px;">
                                        <input type="text" class="form-control searchbox" id="customer" placeholder="find by firstname or email..." name="cartrule[customer]" value="<?php if($model->customer_id != 0) echo $model->customer->email; ?>">
                                        <span class="input-group-btn">
                            ...
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group margin" id="datetimepicker1" style="margin: 0px;">
                                        <input  type="text" class="form-control" placeholder="click to set date"  id="example1" name="cartrule[date_from]" value="<?php echo $model->date_from; ?>">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group margin" id="datetimepicker2" style="margin: 0px;">
                                        <input  type="text" class="form-control" placeholder="click to set date"  id="example2" name="cartrule[date_to]" value="<?php echo $model->date_to; ?>">
                                        <!--<input type="text" class="form-control" name="cartrule[date_to]" required>-->
                                        <span class="input-group-addon">
                            ...
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="cartrule[minimum_amount]" value="<?php echo $model->minimum_amount; ?>">
                                </div>
                            </div>
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                <label for="inputEmail3" class="col-sm-2 control-label">Total available</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="cartrule[quantity]" value="<?php echo $model->quantity; ?>">
                                </div>
                            </div>
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                <label for="inputEmail3" class="col-sm-2 control-label">Total available for each user</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="cartrule[quantity_customer]" value="<?php echo $model->quantity_per_user; ?>">
                                </div>
                            </div>
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="checkbox" name="cartrule[product_restriction]" value="1" id="product-selection" onchange="checkproductselection()" <?php if($model->product_restriction == 1) echo 'checked'; ?>> Product selection<br/>
									<input type="checkbox" name="cartrule[product_category_restriction]" id="category-selection" onchange="checkcategoryselection()" <?php if($model->product_category_restriction == 1) echo 'checked'; ?>>Category selection<br/><br/>
                            ...
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" name="cartrule[free_shipping]">
                                        <option value="1" <?php if($model->free_shipping == 1) echo 'selected'; ?>>Yes</option>
                                        <option value="0" <?php if($model->free_shipping == 0) echo 'selected'; ?>>No</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group" style="padding: 2% 0 3% 0;">
