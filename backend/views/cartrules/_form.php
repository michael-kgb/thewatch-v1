                    ...
                    <div class="tab-pane active" id="information">
                        <div class="box-body">
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="cartrule[name]" id="voucherName" placeholder="Name" required="true">
                                </div>
                            </div>
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="checkbox" name="cartrule[product_restriction]" value="1" id="product-selection" onchange="checkproductselection()"> Product selection<br/>
									<input type="checkbox" name="cartrule[brand_restriction]" value="1" id="brand-selection" onchange="checkbrandselection()"> Brand selection<br/>
									<input type="checkbox" name="cartrule[product_category_restriction]" value="1" id="category-selection" onchange="checkcategoryselection()"> Category selection<br/><br/>
									<table id="table-brand-selection" style='display: none; width: 100%; margin-top: 5%;'>
                                        <tbody>
                                            <tr>
                                                <td width="20%">
                                                    <div>
                                                ...
                                                <td width="40%">
                                                    <div style="padding-left: 20px; padding-right: 20px;">
                                                        <select class="form-control" name="Brand[brand_id]">
															<?php 
									...
									<table id="table-category-selection" style='display: none; width: 100%; margin-top: 5%;'>
                                        <tbody>
                                            <tr>
                                                <td width="20%">
                                                    <div>
                                                ...
                                                <td width="40%">
                                                    <div style="padding-left: 20px; padding-right: 20px;">
                                                        <select class="form-control" name="ProductCategory[product_category_id]">
															<?php 
																$productCategory = \backend\models\ProductCategory::findAll(['product_category_status' => 'active']); 
                                    ...
                                    <table id="table-product-selection" style='display: none; width: 100%; margin-top: 5%;'>
                                        <tbody>
                                            <tr>
                                                <td width="20%">
							...
							<div class="form-group" style="padding: 2% 0 3% 0;">
								...
								<div class="col-sm-10">
                                    <input type="radio" name="cartrule[generator]" onclick="openvalue('regular')" value="regular" checked> Regular Voucher<br>
                                    <input type="radio" name="cartrule[generator]" onclick="openvalue('bulk')" value="bulk"> Bulk Voucher<br>
                                </div>
								<div class="col-sm-2"></div>
								<div class="col-sm-5">
									<table id="table-bulk-selection" style='display: none; width: 100%; margin-top: 5%;'>
										<tbody>
											<tr>
												<td width="20%">
													<div>
												...
												<td width="40%">
													<div style="padding-left: 20px; padding-right: 20px;">
														<input type="text" class="form-control" name="cartrule[bulk_quantity]" value="0">
													</div>
												</td>
											</tr>
										</tbody>
