                ...
                <tr>
                    ...
                    <td>
                      <table width="600" cellspacing="0" cellpadding="0" align="left" style="padding-bottom:35px;padding-top:45px;">
                        <tr>
                          ...
                          <td>
                            <table width="245"></table>
                          </td>
                          <td align="left" width="108">
                            <img src="https://gallery.mailchimp.com/7e02983712f248a4df84d988d/images/c2a7359b-b097-418a-ac5f-53c286afac04.png" alt="343e5cc8-305b-4192-9404-7d788544b83e.png" width="108">
                        ...
                        <tr>
                          ...
                          <td align="center" width="570">
                            <div style="font-size:14px;line-height:1.3;text-align:center;font-family:Helvetica;margin-bottom: 15px;">
                              Berikut detail pengajuan garansi baru
                  ...
                  <tr>
                    <td>
                      ...
                      ?>
                      <table width="600" cellspacing="0" cellpadding="0" align="left" style="padding-bottom:35px">
                        <tr>
                          <!-- Row container for Intro/ Description -->
                          <td width="150">
                          ...
                          <td align="left" width="130">
                            <div style="font-size:14px;line-height:1.3;text-align:left;font-family:Helvetica;margin-bottom: 5px;">
                              Hari/Tanggal  
                          ...
                          <td align="left" width="160">
                            <div style="font-size:14px;line-height:1.3;text-align:left;font-family:Helvetica;margin-bottom: 5px;">
                               <?php echo date('d F Y', strtotime($data->service_claim_manual_date_add)); ?>                            
                            </div>
                            <div style="font-size:14px;line-height:1.3;text-align:left;font-family:Helvetica;margin-bottom: 5px;">
                               <?php echo date('h:m', strtotime($data->service_claim_manual_date_add)); ?>   
                              
                            </div>
                            <div style="font-size:14px;line-height:1.3;text-align:left;font-family:Helvetica;margin-bottom: 5px;">
                               <?php echo $data->customer->firstname; ?>
                        ...
                        <tr>
                          ...
                          <td align="left" width="160">
                            <div style="font-size:14px;line-height:1.3;text-align:left;font-family:Helvetica;margin-bottom: 5px;">
                              <?php echo $data->stores->store_name.' '.$data->stores->store_slug; ?>
                        ...
                        <tr>
                          ...
                          <td align="left" width="160">
                            <div style="font-size:14px;line-height:1.3;text-align:left;font-family:Helvetica;margin-bottom: 5px;">
                               <?php echo $data->product->brands->brand_name.' - '.$data->product->productDetail->name; ?>                    
                            </div>
                    ...
                    <td>
                      <table width="600" cellspacing="0" cellpadding="0" align="left" style="padding-bottom:35px;">
                        <tr>
                          <!-- Row container for Intro/ Description -->
                          <td>
                            <table width="208"></table>
                          </td>
                          <td align="left" width="183">
                            <a href="//www.thewatch.co/backend/web/servismanual/view/<?php echo $data->service_claim_manual_id; ?>">
                            <img src="https://gallery.mailchimp.com/7e02983712f248a4df84d988d/images/6f4a08e2-fb79-4ce2-a889-eb44c7caca80.png">
                            </a>
                          </td>
                          <td>
                            <table width="208"></table>
