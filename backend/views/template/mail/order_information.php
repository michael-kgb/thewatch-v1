                          ...
                          <td align="center" style="padding-top:25px;" width="600">
                            <a style="text-decoration:none;color:#454545;font-size:18px;font-weight:bold;text-align:center;">
                              <?php if($id == 'packing_order'){
                                    ...
                                    }elseif($id == 'payment_accepted' || $id == 'payment_success'){
                        ...
                        <tr>
                          ...
                          <td align="center" width="570">
                            <div style="font-size:14px;line-height:1.3;text-align:center;font-family:Helvetica;margin-bottom: 15px;">
                              <?php if($id == 'packing_order'){
                                    ...
                                    elseif($id == 'shipped'){
                                      ...
                                      echo "Pesanan Anda telah dibatalkan. Terima kasih telah berbelanja di The Watch Co.";
                                    }
                            ...
                            <table width="570" align="left" cellpadding="0" cellspacing="0" style="margin-top:5px;font-size: 14px;text-align: center;margin-bottom:20px;">
                              <tr>
                                <td width="107"></td>
                                <td width="170" style="background-color: rgb(160,29,34);color: #fff;border-radius: 25px;padding-top: 5px;padding-bottom: 5px;"><a href="https://www.thewatch.co/status/cancel/<?php echo $token; ?>/<?php echo $model->reference; ?>" style="color: #fff;text-decoration:unset;">Tidak Setuju</td>
                                <td width="15">
                                </td>
                                <td width="170" style="background-color: rgb(32,97,103);color: #fff;border-radius: 25px;padding-top: 5px;padding-bottom: 5px;"><a href="https://www.thewatch.co/status/agree/<?php echo $token; ?>/<?php echo $model->reference; ?>" style="color: #fff;text-decoration:unset;">Setuju</td>
                                <td width="107"></td>
                            ...
                            <?php if($id == 'payment_accepted' || $id == 'payment_success'){ ?>
                            ...
                            <div style="font-size:14px;line-height:1.3;text-align:center;font-family:Helvetica;margin-bottom: 15px;">
                              ...
                              <?php if($id == 'payment_accepted'){
                                    ...
                                    }elseif($id == 'payment_success'){
                                      echo "Permbayaran Berhasil";
                                    }
                            ...
                            <?php }elseif($id == 'packing_order' || $id == 'goods_pass_quality_check_and_ready_to_packing' || $id == 'goods_not_pass_quality_check' || $id == 'shipped' || $id == 'order_canceled'){ ?>
                              <div style="font-size:14px;line-height:1.3;text-align:center;font-family:Helvetica;margin-bottom: 15px;">
