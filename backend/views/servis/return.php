	...
	<div class="row">
		<div class="col-12">
			<div class="page-title-box">
				<h4 class="page-title float-left">Daftar Service Drop dari Service Center</h4>

				<ol class="breadcrumb float-right">
					<li class="breadcrumb-item"><a href="#">Service Drop dari Service Center</a></li>
				</ol>
	...
	<div class="row">
		<div class="col-12">
			<div class="card-box table-responsive m-b-30">
				<h4 class="m-t-0 header-title m-b-30"><b>Filter Service Drop dari Service Center</b></h4>
								...
								<div class="form-group">
									<?php 
										...
										if($departement == "Store Staff"){
											$storeModel = Stores::findAll(["store_status" => "active", "store_id" => $store_id]); 
										}
									?>
...
<script>
var dataUrl = baseUrl + "/servis/getallservicereturn",
	dataColumn = [
