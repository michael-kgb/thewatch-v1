                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="checkbox" name="cartrule[product_restriction]" value="1" id="product-selection" onchange="checkproductselection()" <?php if($model->product_restriction == 1) echo 'checked'; ?>> Product selection<br/><br/><br/>
