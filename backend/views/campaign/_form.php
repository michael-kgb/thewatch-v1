                        ...
                        <div class="box-body">
                            ...
                            <?php if ($model->marketing_campaign_banner != '') { ?>
                                <div class="form-group" style="padding: 2% 0 3% 0;">
                                    ...
                                    <div class="col-lg-10">
                                        <img width="50%" height="50%" src="<?php echo Yii::$app->urlManager->getBaseUrl() . Yii::$app->params['brandAsset'] . $model->marketing_campaign_banner; ?>">
                                    </div>
                                </div> 
                            <?php } ?>  
							...
							<div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-5" style="margin-top: 3%;">
                                    <div class="input-group margin" id="datetimepicker1" style="margin: 0px;">
                                        <input type="text" class="form-control" placeholder="click to set date" id="example1" required="true" name="MarketingCampaign[marketing_campaign_date_from]">
								...
								<div class="col-sm-5" style="margin-top: 3%;">
                                    <div class="input-group margin" id="datetimepicker1" style="margin: 0px;">
                                        <input type="text" class="form-control" placeholder="click to set date" id="example1" required="true" name="MarketingCampaign[marketing_campaign_date_to]">
                                        <span class="input-group-addon">
                            ...
                            <div class="form-group" style="padding: 2% 0 3% 0;">
                                ...
                                <div class="col-sm-4">
                                    <select id="kota" class="form-control kota" name="MarketingCampaign[marketing_campaign_status]">
