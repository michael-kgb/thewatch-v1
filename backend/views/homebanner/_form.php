...
/* @var $form yii\widgets\ActiveForm */\Cloudinary::config(array(    "cloud_name" => "thewatch-co",     "api_key" => "517924523584363",     "api_secret" => "xVVa4kXkWCV6T6CGIIS0DemOg28" ));
?>
        ...
        <div class="col-lg-12">
		  ...
		  <div class="box-body">
                ...
                <div class="form-group">
					...
					<div class="col-lg-10">
						<img src="https://www.thewatch.co/frontend/web/img/homebanner/<?php echo $model->homebanner_images; ?>jpg" class="img-responsive" alt="<?php echo $model->homebanner_description; ?>">
					</div>
				</div>
			</div> 
                <?php } ?>
                ...
                <div class="form-group">
					...
					<div class="col-lg-10">
						<img src="https://www.thewatch.co/frontend/web/img/homebanner/<?php echo $model->homebanner_images_mobile; ?>jpg" class="img-responsive" alt="<?php echo $model->homebanner_description; ?>">
					</div>
                </div> 
                <?php } ?>
