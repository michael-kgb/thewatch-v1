    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                ...
                <button class="btn btn-info" onclick="location.href = '<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/kontes/export'">Export Excel</button>
                            ...
                            <tbody>
                                ...
                                foreach ($data as $row) {
                                    ...
                                    if($row->kontes_seo_status == 'pending'){
                                        ...
                                        echo '<li><a style="cursor:pointer;" href="'. \yii\helpers\Url::base() .'/kontes/approved/' . $row->kontes_seo_id . '">Approved</a></li>';
                                        echo '<li><a style="cursor:pointer;" href="'. \yii\helpers\Url::base() .'/kontes/disapproved/' . $row->kontes_seo_id . '">Disapproved</a></li>';
                                        echo '</ul></div>';
                                    }
                                    if($row->kontes_seo_status == 'approved'){
                                        ...
                                        echo '<ul class="dropdown-menu" role="menu">';
                                        echo '<li><a style="cursor:pointer;" href="'. \yii\helpers\Url::base() .'/kontes/pending/' . $row->kontes_seo_id . '">Pending</a></li>';
                                        echo '<li><a style="cursor:pointer;" href="'. \yii\helpers\Url::base() .'/kontes/disapproved/' . $row->kontes_seo_id . '">Disapproved</a></li>';
                                        echo '</ul></div>';
                                    }
