...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo Yii::$app->urlManager->getBaseUrl(); ?>/storelocation/index"><i class="glyphicon glyphicon-shopping-cart"></i>Stores</a></li>
...
<section class="content">
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <button class="btn btn-info" onclick="location.href = '<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/storelocation/create'">Add New</button>
                    ...
                    <div class="box-body">
                        <table id="data-grid" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                echo '<li><a href="update/' . $row->store_id . '"><i class="fa fa-fw fa-pencil"></i> Update</a></li>';
