    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                ...
                if ($add_access == 1) {
                    ?>
                    <button class="btn btn-info" onclick="location.href = '<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/company/create'">Add New</button>
                    <?php
                }
                ?>
