...
use Yii;
use backend\models\OrderEvent;
// use backend\models\KontesSeo;
...
class HeritageController extends Controller
{
    ...
    public function actionIndex() {
        ...
        $model = OrderEvent::find()->orderBy([
           'order_event_id'=>SORT_DESC,
    ...
    public function actionExport()
    {
            ...
            \common\components\PHPExcel_Helper::generateHeritage(
                'Excel'
            );
    }
    ...
    // {
    //     $model = KontesSeo::find()->where(['kontes_seo_id'=>$id])->one();
    ...
    {
        if (($model = OrderEvent::findOne($id)) !== null) {
            return $model;
        } else {
