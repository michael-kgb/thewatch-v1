...
/**
 * This is the model class for table "blog_competition".
 *
 ...
 * @property string $kontes_seo_status
 */
class BlogCompetition extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function attributeLabels()
    {
        return [
            ...
            'kontes_seo_status' => 'Kontes Seo Status',
        ];
    }
}
