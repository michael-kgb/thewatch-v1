...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2016 at 11:19 AM
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `total_discounts` int(18) NOT NULL,
  `total_paid` int(18) NOT NULL,
  `total_products` int(18) NOT NULL,
  `total_shipping` int(18) NOT NULL,
  `total_wrapping` int(18) NOT NULL,
  ...
  KEY `id_carrier` (`carrier_id`),
  KEY `id_lang` (`apps_language_id`),
  KEY `id_currency` (`currency_id`),
  KEY `id_address_delivery` (`address_delivery_id`),
  KEY `id_address_invoice` (`address_invoice_id`)
